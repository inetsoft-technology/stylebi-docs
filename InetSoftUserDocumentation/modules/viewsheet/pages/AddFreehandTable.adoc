...
+
image::viewsheet:Freehand Table Sort3.png[alt="right-click freehand table and select Sorting"]
+
This opens the '`Sorting`' dialog box.

. Press the {buttonSort} next to field you want to sort.
+
image::viewsheet:Freehand Table Sort5.png[alt="press Sort button next to field to sort"]
+
