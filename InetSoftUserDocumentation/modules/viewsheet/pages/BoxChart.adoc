...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Box (box-and-whisker) chart, which displays a measure's distribution in terms of median, minimum, maximum, first quartile, and third quartile, with individual outliers shown as separate points.
endif::ai[]
