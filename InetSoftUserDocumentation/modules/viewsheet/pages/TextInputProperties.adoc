...
== Option Tab
The *Option* tab in the ‘TextInput Properties’ panel allows you to select an *Input Editor* which specifies the control interface and validation for user input. See xref:viewsheetscript:WriteBackToDatabase.adoc#ValidateUserInput[Validate User Input] for details on the available editors.
