...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Scatter Contour chart, which shows density contours for scatter plot points without displaying the individual points. Useful for visualizing data concentration patterns. See ContourMapChart to overlay contours on a geographic map.
endif::ai[]
