...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Scatter Matrix chart, which is a grid of scatter plots where multiple measures are plotted against one another in all pairwise combinations. Useful for identifying correlations between several measures simultaneously.
endif::ai[]
