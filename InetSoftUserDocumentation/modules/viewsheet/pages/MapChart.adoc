...
image::viewsheet:galleryBubble2.png[alt="Global Visual Analysis world map dashboard sample"]
...
image::viewsheet:galleryMap2.png[alt="Marketing Lead Trends state map dashboard sample"]
...
image::viewsheet:galleryHurricane2.png[alt="Hurricane map chart dashboard sample"]
