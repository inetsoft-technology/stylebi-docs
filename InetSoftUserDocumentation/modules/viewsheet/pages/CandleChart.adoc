...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Candle (candlestick) chart, which plots four measures (low, high, open, close) against a date dimension for financial or trading data. Functionally similar to StockChart but with a filled-body visual style.
endif::ai[]
