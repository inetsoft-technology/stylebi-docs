...
+
image::viewsheet:MultipleStyles1.png[alt="expand Visual panel menu to select measure for styling"]
...
image::viewsheet:galleryDataTip2.png[alt="Executive Sales Summary multiple style chart dashboard"]
