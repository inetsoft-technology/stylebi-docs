...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating an Area chart, which displays a measure as a filled region. It is functionally identical to a Line chart, with the additional option of creating stacked area variants. See BasicChartingSteps for general charting steps.
endif::ai[]
...
image::viewsheet:galleryWaterfall2.png[alt="area chart dashboard example"]
