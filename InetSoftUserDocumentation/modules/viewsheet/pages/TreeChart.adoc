...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Tree chart, which visualizes organizational hierarchies or parent-child relationships as a tree-shaped diagram with nodes and branches. Requires Source and Target dimension fields defining parent-child pairs.
endif::ai[]
