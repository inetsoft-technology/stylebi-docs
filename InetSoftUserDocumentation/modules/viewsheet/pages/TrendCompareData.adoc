...
// metadata for AI
ifdef::ai[]
Summary: Explains how to apply trend and comparison methods to Chart or Crosstab measures, such as percent of total, change from previous group, moving averages, and running totals. These methods are set via the Trend and Comparison option in the Edit Measure panel.
endif::ai[]
...
==== Add Percent Trend and Comparison
[start=10]
...
image::viewsheet:galleryMultipleMeasure3.png[alt="sales revenue profit analysis dashboard example"]
