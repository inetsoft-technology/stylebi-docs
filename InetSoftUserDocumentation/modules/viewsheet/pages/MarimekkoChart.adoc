...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Marimekko (Mekko/mosaic) chart, which displays a measure using variable-width and variable-height rectangles arranged in columns. Place a dimension in the X region for columns and another dimension in the Color or Break By region for the grouping within columns.
endif::ai[]
