...
// metadata for AI
ifdef::ai[]
Summary: Explains how to save a Dashboard in Visual Composer to either a public location (accessible to all users with read permission) or a private location (creator-only). Covers Save vs. Save As and the requirement for write permission.
endif::ai[]
...
+
image::viewsheet:viewsheetExp10.png[alt="save dashboard to public location"]
+
