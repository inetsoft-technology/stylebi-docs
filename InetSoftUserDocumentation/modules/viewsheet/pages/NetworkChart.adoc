...
image:commonscript:networkChart1.png[]
...
+
image:commonscript:networkChart1VS.png[]
...
+
image:commonscript:networkChart8VS.png[]
...
+
image:commonscript:networkChart9VS.png[]

. To add labels to the nodes, drag a dimension to the ‘Text’ region.
+
image:commonscript:networkChart10VS.png[]
