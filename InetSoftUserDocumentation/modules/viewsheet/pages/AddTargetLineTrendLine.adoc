...
image::viewsheet:galleryTargetBand2.png[alt="generation and distribution dashboard target band"]
...
image::viewsheet:galleryMap2.png[alt="marketing lead trends dashboard trend lines"]
