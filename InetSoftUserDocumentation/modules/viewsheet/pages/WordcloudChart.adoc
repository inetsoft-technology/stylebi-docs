...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Word Cloud chart, which displays dimension labels at sizes and/or colors proportional to an associated measure value (e.g., frequency of occurrence). Place the dimension in the T region and the measure in the Size or Color region.
endif::ai[]
