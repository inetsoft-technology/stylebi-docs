...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Circle Packing chart, which represents a measure using hierarchically nested circles. Place hierarchical dimensions in the T region and the measure in the Size region; use the Color region to distinguish groups.
endif::ai[]
