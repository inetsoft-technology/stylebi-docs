...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Running Total chart, which displays an aggregated measure that accumulates across dimension groups, with optional reset points. See CompareDataByDate for related date-based comparisons and TrendCompareData for setting trend/comparison methods.
endif::ai[]
