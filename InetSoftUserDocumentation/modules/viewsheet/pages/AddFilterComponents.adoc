...
Data values from the compatible columns in the added data blocks are merged into the existing Filter component, and the Filter component will filter all of the specified compatible data blocks (in addition to the data block bound to the Filter).
