...
// metadata for AI
ifdef::ai[]
Summary: How to create a new Dashboard from the User Portal, covering two starting paths: the Dashboard Wizard (guided, auto-generates layout from a data source) and the Visual Composer (blank canvas). Explains how to select a data source (Data Worksheet, data model, or database table) and how to open an existing Dashboard for editing.
endif::ai[]
...
+
image::viewsheet:portalDesignTab.png[alt="press Create and select Dashboard"]
+
