...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Contour Map chart, which combines a MapChart with a ScatterContourChart to display data density either by geographic region (country, state, city) or by latitude/longitude coordinates. Supports optional web map backgrounds.
endif::ai[]
