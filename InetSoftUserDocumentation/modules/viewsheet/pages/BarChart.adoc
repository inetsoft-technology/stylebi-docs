...
// metadata for AI
ifdef::ai[]
Summary: How to create a Bar Chart in a Dashboard, including grouped, stacked, and 100% stacked variants. Covers binding dimensions and measures, selecting bar style options, and configuring color and size encodings. See BasicChartingSteps for general chart creation fundamentals.
endif::ai[]
...
image::viewsheet:galleryBar2.png[alt="bar chart dashboard example"]
