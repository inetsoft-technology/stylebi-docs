...
// metadata for AI
ifdef::ai[]
Summary: Explains how to use the Search feature in Visual Composer to locate Dashboard components by name. Type in the Search box at the bottom of Visual Composer to find components with matching Name properties (not Title properties). Use Previous/Next buttons to cycle through matches.
endif::ai[]
...
image::search1.png[alt="type name in Search field to find components"]
