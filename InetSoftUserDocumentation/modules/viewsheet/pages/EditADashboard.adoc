...
// metadata for AI
ifdef::ai[]
Summary: Explains how to open an existing Dashboard for editing in Visual Composer, either from the Portal toolbar or by double-clicking/dragging in the Assets panel. Recommends using a development or test environment for edits rather than production.
endif::ai[]
