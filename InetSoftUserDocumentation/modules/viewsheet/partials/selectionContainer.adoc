...
+
image:SelectionContainerAddDataBlock.png[alt="drag data field onto Selection Container"]
+
...
image:SelectionContainer1.png[alt="press Show to expand selection component"]
...
image:SelectionContainer2.png[alt="press Unselect All to clear filters"]