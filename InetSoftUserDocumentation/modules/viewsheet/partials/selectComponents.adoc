...
image:viewsheet:Move Handle_1.png[alt="component move and resize handles"]
...
image:viewsheet:Drag Select Multiple Components.png[alt="drag mouse to select multiple components"]
