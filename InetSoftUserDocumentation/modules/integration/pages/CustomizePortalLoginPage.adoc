...
// metadata for AI
ifdef::ai[]
Summary: How to customize the StyleBI User Portal login page by replacing the login.html and login.css files in the inetsoft web resources directory inside a custom Docker image.
endif::ai[]
