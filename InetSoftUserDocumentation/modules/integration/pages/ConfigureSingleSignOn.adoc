...
// metadata for AI
ifdef::ai[]
Summary: How to configure Single Sign-On (SSO) in StyleBI Enterprise, covering three methods: OpenID Connect, SAML, and Custom Filter (Java class or inline Groovy). Includes step-by-step instructions and configuration parameters for each SSO method.
endif::ai[]
