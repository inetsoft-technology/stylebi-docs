...
// metadata for AI
ifdef::ai[]
Summary: URL syntax reference for accessing StyleBI components from external web applications, including displaying the User Portal, individual portal tabs, Dashboards (public and private), exporting Dashboards, embedding interactive charts via IFrame or web component, passing parameters to Dashboards, and pinging the server. Covers IFrame embedding and cross-page communication.
endif::ai[]
