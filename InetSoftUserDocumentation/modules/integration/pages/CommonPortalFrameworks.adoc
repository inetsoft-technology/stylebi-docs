...
// metadata for AI
ifdef::ai[]
Summary: Integration guidance for common portal frameworks, specifically Microsoft IIS Web Server and SharePoint Portal Framework. Explains that StyleBI must run on a J2EE-compliant server and can be embedded in SharePoint Web Parts or IIS-hosted pages via URL.
endif::ai[]
