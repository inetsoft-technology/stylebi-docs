...
See xref:dashboardscript:AccessDataSourceData.adoc#ReferenceDatasourceData[Reference Datasource Data] for more information on the syntax for accessing data columns. See xref:commonscript:CalcObjectFunctions.adoc[] for additional script functions.