...
+
image:administration:Creation Parameters1.png[alt="add parameter dialog opened after pressing the Add button"]
...
+
image:administration:Creation Parameters2.png[alt="value type set to Value with fixed value entered in the Value field"]
+
...
====
+
image:administration:scheduleActionDynamicDates.png[alt="formula editor showing dynamic dates folder with predefined date values"]

. Press btn:[OK] to close the dialog box. The parameter that you added is now listed in the table.
+
image:administration:Creation Parameters3.png[alt="creation parameters table showing the newly added parameter entry"]
