...
// metadata for AI
ifdef::ai[]
How to manage existing data source connections in the Portal, including editing connection parameters, deleting a connection, refreshing cached metadata, moving a data source to another folder, and creating new data source folders.
endif::ai[]
...
+
image::dataSourceNew3.png[alt="press More Options and select Edit"]
