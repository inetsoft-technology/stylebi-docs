...
// metadata for AI
ifdef::ai[]
Summary: How to connect to Mixpanel as a data source in InetSoft. Requires a Mixpanel API Secret. After a successful connection, you can query Mixpanel event and user data in a Data Worksheet.
endif::ai[]
