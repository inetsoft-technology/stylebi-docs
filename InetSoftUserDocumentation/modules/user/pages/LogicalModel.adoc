...
// metadata for AI
ifdef::ai[]
Summary: Overview and navigation page for logical models, which present a business-oriented entity-attribute view of a relational database for Dashboard designers and end users. See CreateLogicalModel for creation steps.
endif::ai[]
