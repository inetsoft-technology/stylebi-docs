...
// metadata for AI
ifdef::ai[]
Summary: How to connect to Aster Data nCluster as a data source in InetSoft using a custom JDBC driver. Requires a plugin driver, the driver class name, and a JDBC URL of the form jdbc:ncluster://<hostname>:<port>/<database>, plus login credentials.
endif::ai[]
