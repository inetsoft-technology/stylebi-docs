...
ifdef::ai[]
Summary:
Explains how join paths are visually represented in a Physical View, where dotted join paths indicate weak joins used to resolve join cycles or join ambiguity, while solid join paths represent normal joins.
endif::ai[]
