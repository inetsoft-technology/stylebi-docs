...
// metadata for AI
ifdef::ai[]
Summary: How to connect to Apache Drill as a data source in InetSoft using a custom JDBC driver. Requires a plugin driver, the driver class name, and a JDBC URL of the form jdbc:drill:zk=<zk name>[:<port>], plus login credentials.
endif::ai[]
