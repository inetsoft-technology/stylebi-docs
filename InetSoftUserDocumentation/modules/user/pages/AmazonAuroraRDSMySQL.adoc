...
// metadata for AI
ifdef::ai[]
Summary: How to connect to Amazon Aurora RDS MySQL as a data source in InetSoft. Requires a plugin driver; supports both a custom connection URL and manual entry of Host Name, Port, Database Name, and credentials. Uses MySQL database type.
endif::ai[]
