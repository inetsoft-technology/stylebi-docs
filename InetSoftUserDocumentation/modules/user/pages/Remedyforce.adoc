...
. Select the ‘Remedyforce’ data source, and press btn:[Create]. This opens the data source definition screen.
+
image:dataSourceNewRemedyforce2.png[]

. In the ‘Name’ field, enter a label for this data source connection.

. Enter the required credentials and ‘Security Token’.
+
...
After you have created a connection to the database, you can proceed to define a data set. See xref:dataworksheet:QueryRemedyforce.adoc[].