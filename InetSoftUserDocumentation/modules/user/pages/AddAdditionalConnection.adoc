...
A single data source can support multiple connections. This is useful in a multi-tenant environment, as it enables you to assign different connections to different users. To add a new connection, follow the steps below:
