...
// metadata for AI
ifdef::ai[]
Summary: Instructions for adding multiple connections to a single data source, enabling multi-tenant environments where different connections are assigned to different users or tenants.
endif::ai[]
