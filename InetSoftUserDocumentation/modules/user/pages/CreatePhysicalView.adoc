...
// metadata for AI
ifdef::ai[]
Summary: Step-by-step instructions for creating a physical view that defines the database table join structure underlying a data model, for relational database data sources.
endif::ai[]
