...
// metadata for AI
ifdef::ai[]
Summary: How to create a custom JDBC data source connection in InetSoft for databases not covered by built-in connectors. Requires uploading a JDBC driver plugin, specifying the Driver Class and JDBC URL, and providing login credentials. Covers connection testing and common database URL formats for Oracle, DB2, MySQL, SQL Server, and others.
endif::ai[]
