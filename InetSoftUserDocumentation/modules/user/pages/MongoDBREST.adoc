...
// metadata for AI
ifdef::ai[]
Summary: How to connect to MongoDB via REST as a data source in InetSoft. Requires Host, Port, ReplicaSet, Database name, and security credentials. After a successful connection, you can query MongoDB REST data in a Data Worksheet.
endif::ai[]
