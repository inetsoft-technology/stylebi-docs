...
// metadata for AI
ifdef::ai[]
Summary: Guidance on whether to create a data model for a relational database. Explains the benefits of logical models for self-service, reducing query maintenance, and simplifying data access for Dashboard designers.
endif::ai[]
