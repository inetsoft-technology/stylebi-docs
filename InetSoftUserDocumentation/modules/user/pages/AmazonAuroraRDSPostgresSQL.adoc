...
// metadata for AI
ifdef::ai[]
Summary: How to connect to Amazon Aurora RDS PostgreSQL as a data source in InetSoft. The PostgreSQL driver is bundled with InetSoft; supports both a custom connection URL and manual entry of Host Name, Port, Database Name, and credentials.
endif::ai[]
