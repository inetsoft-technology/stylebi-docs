...
// metadata for AI
ifdef::ai[]
Summary: Instructions for connecting to SharePoint Online as a data source in InetSoft. Covers connection parameters, authentication, and any driver or API key requirements. See ConnectToDataSource for the full list of available connectors.
endif::ai[]
...
+
image::dataSourceNewSharePointOnline2.png[alt="SharePoint Online data source definition screen"]
...
+
image::dataSourceSharePointOnline3.png[alt="connection successful icon"]
+
If the database is shown with an {buttonError}, this means that the connection was not successful.
+
image::dataSourceSharePointOnline4.png[alt="connection error icon"]
+
