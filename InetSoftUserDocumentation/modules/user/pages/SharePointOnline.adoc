...
// metadata for AI
ifdef::ai[]
Summary: How to connect to SharePoint Online as a data source in InetSoft. Requires entering a SharePoint username and password, plus Azure AD application credentials: Client ID, Tenant ID, and Client Secret.
endif::ai[]
