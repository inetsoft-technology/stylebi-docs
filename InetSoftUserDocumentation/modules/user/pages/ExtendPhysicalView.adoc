...
// metadata for AI
ifdef::ai[]
Summary: How to create a tenant-specific physical view extension in a multi-tenant environment, adding tenant-specific database tables alongside shared tables. Enterprise only.
endif::ai[]
