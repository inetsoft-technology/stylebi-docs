...
// metadata for AI
ifdef::ai[]
Summary: How to connect to the 42Matters app analytics data source in InetSoft. Requires an Access Token from the 42Matters API; supports a Free Trial account option. After connecting, query data via the Data Worksheet.
endif::ai[]
