...
// metadata for AI
ifdef::ai[]
Summary: How to connect to Pipedrive CRM as a data source in InetSoft. Requires entering a Domain and API Token. After connecting, proceed to define a data set using the Pipedrive query page.
endif::ai[]
