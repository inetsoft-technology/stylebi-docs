...
// metadata for AI
ifdef::ai[]
Summary: How to add a scripted trigger to a VPM row condition, allowing the condition to be applied selectively based on user role, group, or identity. Requires an existing VPM. See CreateNewVPM and AddDataSecurity.
endif::ai[]
