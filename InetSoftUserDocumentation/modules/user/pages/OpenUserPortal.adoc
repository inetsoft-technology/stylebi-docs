...
{buttonCreate}:: Create data sources, Data Worksheets, and Dashboards. See xref:ConnectToData.adoc[], xref:dataworksheet:CreateNewWorksheet.adoc[], and xref:dashboard:CreateNewDashboard.adoc[] for more information.
