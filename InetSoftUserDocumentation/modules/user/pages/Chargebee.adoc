...
// metadata for AI
ifdef::ai[]
Summary: How to connect to Chargebee (subscription billing) as a data source in InetSoft. Requires the Chargebee Subdomain and API Key. After connecting, query data via the Data Worksheet.
endif::ai[]
