...
// metadata for AI
ifdef::ai[]
Summary: How to configure HikariCP connection pool settings for a data source, including pool size, timeout, and other HikariCP knobs. Enterprise only.
endif::ai[]
...
+
image::administration:ConnectionPooling1.png[alt="press New in Connection Pool Properties panel"]
...
+
image::ConnectionPooling2.png[alt="add property and press OK"]
