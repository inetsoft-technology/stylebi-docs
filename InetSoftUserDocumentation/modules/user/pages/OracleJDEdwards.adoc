...
. Select the ‘Oracle JD Edwards’ data source, and press btn:[Create]. This opens the data source definition screen.
+
image:dataSourceNewOracleJDEdwards2.png[]
...
+
 jdbc:oracle:enterpriseone://{host}:{port}/{ERP Environment}
