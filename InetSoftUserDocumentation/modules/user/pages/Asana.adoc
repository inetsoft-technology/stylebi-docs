...
// metadata for AI
ifdef::ai[]
Summary: How to connect to Asana (project management) as a data source in InetSoft. Requires an Asana Personal Access Token. After connecting, query data via the Data Worksheet.
endif::ai[]
