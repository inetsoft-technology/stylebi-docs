...
+
image:dataSourceNewSalesforceReportsandDashboards2.png[]
...
+
image:dataSourceSalesforceReportsandDashboards4.png[]
+
If the database is shown with an {buttonError}, this means that the connection was not successful.
+
image:dataSourceSalesforceReportsandDashboards3.png[]
+
