...
// metadata for AI
ifdef::ai[]
Summary: How to specify hidden columns in a VPM to restrict user access to specific database table columns. Enterprise only. See AddDataSecurity for VPM overview.
endif::ai[]
