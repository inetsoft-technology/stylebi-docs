...
// metadata for AI
ifdef::ai[]
Summary: Instructions for connecting to Appfigures as a data source in InetSoft. Covers connection parameters, authentication, and any driver or API key requirements. See ConnectToDataSource for the full list of available connectors.
endif::ai[]
...
+
image::dataSourceNewAppfigures2.png[alt="Appfigures data source definition screen"]
...
+
image::dataSourceAppfigures3.png[alt="connection successful icon"]
+
If the database is shown with an {buttonError}, this means that the connection was not successful.
+
image::dataSourceAppfigures4.png[alt="connection error icon"]
+
