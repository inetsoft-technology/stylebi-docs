...
// metadata for AI
ifdef::ai[]
Summary: How to connect to Appfigures (app analytics) as a data source in InetSoft. Requires a Client Key and login credentials. After connecting, query data via the Data Worksheet.
endif::ai[]
