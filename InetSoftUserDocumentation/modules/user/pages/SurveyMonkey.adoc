...
// metadata for AI
ifdef::ai[]
Summary: How to connect to SurveyMonkey as a data source in InetSoft. Uses OAuth authorization — press the Authorize button to populate the token field automatically. No manual token entry is required.
endif::ai[]
