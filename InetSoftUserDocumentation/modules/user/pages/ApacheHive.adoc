...
// metadata for AI
ifdef::ai[]
Summary: How to connect to Apache Hive as a data source in InetSoft. Requires Host, Port, Database, HiveServer Type, and security credentials. After connecting, query data via the Data Worksheet.
endif::ai[]
