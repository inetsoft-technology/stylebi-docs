...
// metadata for AI
ifdef::ai[]
Summary: Instructions for connecting to Apache Hive as a data source in InetSoft. Covers connection parameters, authentication, and any driver or API key requirements. See ConnectToDataSource for the full list of available connectors.
endif::ai[]
...
+
image::dataSourceNewApacheHive.png[alt="Apache Hive data source definition screen"]
...
+
image::dataSourceApacheHive6.png[alt="connection successful icon"]
+
