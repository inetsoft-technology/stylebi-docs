...
// metadata for AI
ifdef::ai[]
Summary: How to connect to Twitter (X) as a data source in InetSoft. Requires a Client ID and Client Secret; pressing Authorize populates the Access Token, Refresh Token, and Token Expiration fields automatically via OAuth.
endif::ai[]
