...
// metadata for AI
ifdef::ai[]
How to organize data sources, logical models, physical views, VPMs, and folders in the Portal data panel, including: creating new folders, moving assets between folders (individually or in bulk using multi-select), deleting assets (individually or in bulk), and renaming assets.
endif::ai[]
