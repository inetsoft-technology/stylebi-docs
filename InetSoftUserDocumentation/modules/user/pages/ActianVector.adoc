...
. Select the ‘Actian Vector’ data source, and press btn:[Create]. This opens the data source definition screen.
+
image:dataSourceNewActianVector2.png[]
