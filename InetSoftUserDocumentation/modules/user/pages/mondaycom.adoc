...
// metadata for AI
ifdef::ai[]
Summary: How to connect to monday.com as a data source in InetSoft. Requires a monday.com API Key for authentication. After entering the API Key and pressing OK, verify the connection status icon to confirm success.
endif::ai[]
