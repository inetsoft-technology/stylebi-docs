...
// metadata for AI
ifdef::ai[]
Summary: How to add a scripted trigger to a VPM lookup to enable or disable the lookup based on user role, group, or identity. Requires an existing VPM. See CreateNewVPM and AddDataSecurity.
endif::ai[]
