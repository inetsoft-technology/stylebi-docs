...
// metadata for AI
ifdef::ai[]
Summary: How to connect to Jive as a data source in InetSoft. Requires a Jive Community URL and login credentials. After a successful connection, you can query Jive data in a Data Worksheet.
endif::ai[]
