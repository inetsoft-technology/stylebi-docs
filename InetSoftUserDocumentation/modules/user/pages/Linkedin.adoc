...
// metadata for AI
ifdef::ai[]
Summary: How to connect to LinkedIn as a data source in InetSoft using OAuth authorization. Press Authorize to populate the token fields. After a successful connection, you can query LinkedIn data in a Data Worksheet.
endif::ai[]
