...
// metadata for AI
ifdef::ai[]
How to manage assets (folders, Dashboards) in the Portal Repository, including searching or filtering the Repository listing, creating folders, renaming, moving, and deleting assets, marking assets as Favorites, and materializing a Dashboard to improve performance.
endif::ai[]

The following sections explain how to manage your assets under the {buttonRepository} of the Portal.

== Search the Repository

To filter the Repository listing, enter  a Dashboard or Folder name (or partial name) in the ‘Search’ box above the Repository, and press the {buttonSearch}.  To limit the result to only favorites, toggle the {buttonFavorites}. (See xref:#FavoriteAsset[] below.) Press the {buttonClearSearchX} to clear the search text.
...
+
image::organizeRepostory.png[alt="right-click folder and select New Folder"]
+
This opens the ‘Create Folder’ page.
+
image::createFolder.png[alt="Create Folder dialog opens"]
...
+
image::organizeRepostory1.png[alt="drag asset to desired folder"]
...
+
image::organizeRepostory2.png[alt="right-click asset and select Delete"]
...
+
image::favorites1.png[alt="right-click asset and select Add to Favorites"]

. To view your list of favorite assets, press the {buttonFavorites}.
+
image::favorites2.png[alt="press Favorites button"]
...
To create a materialized view for a Dashboard (to improve performance), see xref:dashboard:ImprovePerformance.adoc[].
