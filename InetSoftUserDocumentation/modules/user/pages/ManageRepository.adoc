...
// metadata for AI
ifdef::ai[]
How to manage assets (folders, Dashboards) in the Portal Repository, including creating folders, renaming, moving, and deleting assets, marking assets as Favorites, and materializing a Dashboard to improve performance.
endif::ai[]
