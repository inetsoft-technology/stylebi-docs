...
. Select the ‘Splice Machine’ data source, and press btn:[Create]. This opens the data source definition screen.
+
image:dataSourceNewSpliceMachine2.png[]
