...
// metadata for AI
ifdef::ai[]
Summary: How to create a persistent connection to a Text or Excel file (or directory of files) as a data source in InetSoft. You specify a server-side Root Folder path; this differs from a one-time data upload. After connecting, query the files using QueryTextExcelDirectory.
endif::ai[]
