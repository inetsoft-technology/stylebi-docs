...
// metadata for AI
ifdef::ai[]
Summary: How to connect to a REST XML web service as a data source in InetSoft, including how to configure Basic authentication (username/password and HTTP parameters) and Two-step Token authentication (authentication URI, token regex pattern, and query parameters).
endif::ai[]
