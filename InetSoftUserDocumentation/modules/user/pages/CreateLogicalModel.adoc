...
// metadata for AI
ifdef::ai[]
Step-by-step instructions for creating a logical model (data model, semantic layer, business model) on top of a physical view for relational database data sources only. Requires a physical view to be defined first. Covers creating entities and adding attributes (database columns) to those entities, adding SQL expression/formula attributes, editing attribute properties, and naming restrictions for entities and attributes (certain special characters cause problems; attribute names cannot contain a period).
endif::ai[]
...
+
image::dataModel35.png[alt="press New Logical Model button"]


. Provide a name for the logical model and press btn:[OK].
+
image::dataModel36.png[alt="name logical model and press OK"]

. Press the {buttonAddElement}, and select ‘Add Entity’.
+
image::dataModel37.png[alt="press Add Element and select Add Entity"]


. Provide a name for the new entity and press btn:[Next].
+
image::dataModel38.png[alt="name new entity and press Next"]
+
[CAUTION]
====
...
+
image::dataModel39.png[alt="select fields as entity attributes"]
+
This adds the logical model entity and its attributes to the left panel.
+
image::dataModel40.png[alt="entity and attributes added to left panel"]
+
[CAUTION]
====
...
+
image::dataModel41.png[alt="press Add Element and select Add Attribute"]
...
+
image::dataModel42.png[alt="select entity and add attributes"]
...
+
image::dataModel43.png[alt="press Add Element and select Add Expression"]
...
+
image::dataModel44.png[alt="add expression to entity"]
...
+
image::dataModel45.png[alt="select attribute and press Save"]
