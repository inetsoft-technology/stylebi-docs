...
// metadata for AI
ifdef::ai[]
Summary: Step-by-step instructions for creating a logical model on top of a physical view, organizing database columns into business-oriented entities and attributes for relational database data sources.
endif::ai[]
