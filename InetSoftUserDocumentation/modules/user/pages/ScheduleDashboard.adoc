...
// metadata for AI
ifdef::ai[]
Summary: How to schedule automatic Dashboard generation and delivery on a predefined cycle, including quick-scheduling and advanced schedule options for email delivery and format selection.
endif::ai[]
