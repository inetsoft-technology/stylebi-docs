...
+
image::viewsheet:AddBookmark.png[alt="press Bookmarks button"]
...
+
image::viewsheet:AddBookmark2.png[alt="enter name for new bookmark"]
...
+
image::viewsheet:Bookmark Filter.png[alt="press Filter to restrict bookmarks"]

. To filter the list of available bookmarks, type all or part of a Bookmark label in the ‘Search’ field.
+
image::viewsheet:Bookmark Search.png[alt="type in Search field to filter bookmarks"]

. Select the bookmark you want to restore.
+
image::viewsheet:Browse Bookmark Dialog.png[alt="select bookmark to restore"]
...
+
image::viewsheet:Browse Bookmark Dialog.png[alt="select bookmark to update"]
...
+
image::viewsheet:BookmarkDelete1.png[alt="press Remove Bookmarks button"]
...
+
image::viewsheet:BookmarkDelete2.png[alt="select Older than or Not accessed since"]
...
+
image::viewsheet:BookmarkProps.png[alt="press Edit to open Bookmark Properties"]
...
+
image::viewsheet:Bookmark Default.png[alt="press Set as Default button"]
+
