...
// metadata for AI
ifdef::ai[]
Summary: Admin guide for configuring self-service Dashboard creation features, including setting up repository permissions, action permissions, and data source access for end users.
endif::ai[]
