...
. Select the ‘DataStax Enterprise’ data source, and press btn:[Create]. This opens the data source definition screen.
+
image:dataSourceNewDataStaxEnterprise2.png[]
