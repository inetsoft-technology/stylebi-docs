...
// metadata for AI
ifdef::ai[]
Summary: Reference for Gauge component properties in Visual Composer (General, Advanced, Data, Script tabs). A Gauge is also known as a dial, speedometer, KPI dial, or metric dial. Covers gauge style, face/needle appearance, value range, target value, and data binding. See AddAKPI for how to use a Gauge to display a KPI.
endif::ai[]
