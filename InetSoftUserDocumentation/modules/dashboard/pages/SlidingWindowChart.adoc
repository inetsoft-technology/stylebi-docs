...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Sliding Window chart in Visual Composer, which computes aggregates over overlapping data windows (most commonly moving averages, also called rolling averages). See CompareDataByDate for related date-based comparison charts and TrendCompareData for setting trend/comparison methods.
endif::ai[]
...
image::commonscript:movingAverageChartExpw.png[alt="sliding window moving average chart"]
...
+
image::commonscript:barChartExp1.png[alt="press Select Chart Style, choose style"]
...
+
image::commonscript:barChartExp4.png[alt="drag dimension to X or Y region"]
...
+
image::viewsheetExp34.png[alt="set Level to desired date grouping"]
...
+
image::commonscript:pctChangeChartExp1.png[alt="drag measure to X or Y region"]
...
+
image::Chart Edit Y Axis_1.png[alt="press Edit Measure, select aggregation method"]

. From the ‘Trend and Comparison’ menu, select ‘Moving Average’.
+
image::commonscript:movingAverageChartExp1.png[alt="select Moving Average from Trend and Comparison"]
...
image::commonscript:MovingCalculationDialog_1.png[alt="Sliding calculation dialog box"]
...
image::commonscript:movingAverageChartExpw.png[alt="completed sliding window chart"]
