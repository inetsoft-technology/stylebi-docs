...
// metadata for AI
ifdef::ai[]
Summary: Reference for the Submit Button (also called an apply filters button or batch submit button) form component properties. Covers the button label and whether submitting refreshes all Dashboard components or only those filtered by Selection/Form components. See DynamicallySetProperties for how Form components work together.
endif::ai[]
...
* {commonProperties}
* xref:dashboardscript:SubmitButton.adoc[]  in xref:dashboardscript:DashboardObjectReference.adoc[] to set these properties dynamically using script.
...
image::SubmitPropertiesDialogBox.png[alt="submit button general tab properties"]
