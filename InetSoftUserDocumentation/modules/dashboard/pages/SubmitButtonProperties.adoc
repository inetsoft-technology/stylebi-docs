...
// metadata for AI
ifdef::ai[]
Summary: Reference for the Submit Button form component properties. Covers the button label and whether submitting refreshes all Dashboard components or only those filtered by Selection/Form components. See DynamicallySetProperties for how Form components work together.
endif::ai[]
