...
// metadata for AI
ifdef::ai[]
Summary: How to create an Area chart in Visual Composer, which displays a measure as a filled region. It is functionally identical to a Line chart, with the additional option of creating stacked area variants. See BasicChartingSteps for general charting steps.
endif::ai[]

An area chart displays a measure as a filled region. It is functionally the same as a xref:LineChart.adoc[].

image::commonscript:areaChartExp5b.png[alt="area chart example"]
...
+
image::commonscript:areaChartExp1.png[alt="select Area chart style"]
+
...
+
image::commonscript:areaChartExp4.png[alt="drag dimension to X or Y"]
+
...
+
image::commonscript:areaChartExp2.png[alt="drag dimension to Color or Shape"]
...
+
image::commonscript:areaChartExp3.png[alt="drag measure to X or Y"]
+
...
image::dashboard:galleryWaterfall2.png[alt="area chart dashboard example"]
