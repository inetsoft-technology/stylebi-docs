...
// metadata for AI
ifdef::ai[]
How to create a Bar Chart in Visual Composer, including grouped and stacked variants. Covers binding dimensions and measures, selecting the Bar chart style, enabling the Stack option, and configuring color, shape, size, and text encodings. Also explains using the Break By/Tooltip region and setting date dimension grouping levels. See BasicChartingSteps for general chart creation fundamentals.
endif::ai[]

A bar chart displays a measure as filled bars.

image::commonscript:barChartExp5.png[alt="bar chart example"]

To create a bar chart, follow the basic steps below:

include::partial$chartNewbieTip.adoc[]

. Press the {buttonSelectChartStyle}. Choose the ‘Bar’ style.  (To create a stacked bar chart, enable the ‘Stack’ option at the bottom of the panel.) Press the {buttonApply}.
+
image::commonscript:barChartExp1.png[alt="select Bar chart style"]
+
...
+
image::commonscript:barChartExp4.png[alt="drag dimension to X or Y"]
+
...
+
image::commonscript:barChartExp2.png[alt="drag dimension to Color or Shape"]
...
+
image::commonscript:barChartExp3.png[alt="drag measure to X or Y"]
+
...
image::dashboard:galleryBar2.png[alt="bar chart dashboard example"]
