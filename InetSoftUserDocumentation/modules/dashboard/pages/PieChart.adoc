...
// metadata for AI
ifdef::ai[]
Summary: How to create a Pie Chart in Visual Composer. Covers binding a measure to the Y region, binding a dimension to the Color region, choosing the Pie chart style, adding text labels to slices, hiding the legend, and enabling the Explode Pie option to add gaps between slices. See BasicChartingSteps for general chart creation fundamentals.
endif::ai[]
...
. Press the {buttonSelectChartStyle}, and choose ‘Pie’. This converts the chart into a pie-chart representation.
+
...
image::dashboard:galleryGridOfPie2.png[alt="grid of pie charts example"]
