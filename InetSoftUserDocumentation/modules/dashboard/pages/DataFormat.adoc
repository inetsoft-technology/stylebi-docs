...
// metadata for AI
ifdef::ai[]
Summary: How to apply display format patterns (date, number, currency, text, percent) to values in Dashboard components. Formatting controls how data is presented without changing the underlying values. Accessed via the Format panel in Visual Composer.
endif::ai[]
