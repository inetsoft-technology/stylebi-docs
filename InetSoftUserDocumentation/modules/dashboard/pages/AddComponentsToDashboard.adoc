...
// metadata for AI
ifdef::ai[]
Summary: How to add, remove, and manage components in an existing Dashboard. Covers dragging components from the Toolbox, deleting components, and links to component-specific creation pages (Charts, Tables, Filters, etc.). Use this as an orientation page for Dashboard component management.
endif::ai[]
