...
// metadata for AI
ifdef::ai[]
Summary: How to create a Dot Plot chart in Visual Composer, which displays individual (un-aggregated) data points as stacked dots. Best for small datasets with fewer than ~20 points per dimension. Uses Point style with Stack enabled and Aggregate set to None.
endif::ai[]
