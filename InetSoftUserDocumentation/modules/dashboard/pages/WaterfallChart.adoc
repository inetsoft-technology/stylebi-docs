...
// metadata for AI
ifdef::ai[]
Summary: How to create a Waterfall Chart in Visual Composer. A waterfall chart displays how sequential positive and negative values contribute to a cumulative total — useful for financial analysis such as profit/loss breakdowns. See BasicChartingSteps for general chart creation fundamentals.
endif::ai[]
