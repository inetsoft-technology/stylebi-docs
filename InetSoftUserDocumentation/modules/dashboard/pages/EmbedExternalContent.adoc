...
// metadata for AI
ifdef::ai[]
Summary: How to embed external content (a URL) inside a Dashboard in Visual Composer using an automatically generated IFrame via the Text component's 'Embed as URL' option. URL parameters can be passed for filtering child Dashboards. See AddTextOrHTML for manually inserting IFrame HTML.
endif::ai[]
...
+
image::embedURL.png[alt="select embed as URL option"]
...
+
image::embedURL2.png[alt="drag resize handles to size text component"]
...
image::embedURL3.png[alt="embedded content displayed in IFrame at preview"]
