...
// metadata for AI
ifdef::ai[]
Summary: Step-by-step instructions for adding a Chart to a Dashboard in Visual Composer, including understanding dimensions vs. measures, binding data to chart axes, selecting a chart type, and using the Chart Editor. This is the foundational chart creation page — also called chart setup or chart binding — read this before consulting chart-type-specific pages such as BarChart or LineChart.
endif::ai[]
