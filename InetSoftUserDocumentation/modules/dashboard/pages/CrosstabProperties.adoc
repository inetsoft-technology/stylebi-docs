...
// metadata for AI
ifdef::ai[]
Summary: Defines all properties of a Crosstab element, including data layout, summary fields, grid lines, visual/global options, and explains how to display and arrange multiple aggregations, adjust row/column settings, totals, and other Crosstab behaviors in StyleBI.
endif::ai[]
