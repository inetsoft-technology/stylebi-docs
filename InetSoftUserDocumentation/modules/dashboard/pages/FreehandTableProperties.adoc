...
// metadata for AI
ifdef::ai[]
Summary: Reference for Freehand Table component properties, which differ from regular Table properties. Covers header/trailer rows and columns, Shrink to Fit, Fill Blank Cell With Zero, Data Tip, and Flyover Views. See TableProperties for regular Table settings.
endif::ai[]
