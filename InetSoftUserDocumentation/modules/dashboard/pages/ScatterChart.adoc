...
// metadata for AI
ifdef::ai[]
Summary: How to create a Scatter (point) Chart in a Dashboard. Best suited for showing the relationship or correlation between two measures. Covers binding X and Y measure axes, adding a color or size encoding for a third dimension, and creating a bubble chart variant. See BasicChartingSteps for general chart creation fundamentals.
endif::ai[]
...
image::commonscript:galleryScatter8.png[alt="scatter chart example"]
...
+
image::commonscript:galleryScatter1.png[alt="drag dimension to color region"]
+
...
+
image::commonscript:galleryScatter2.png[alt="drag measure to X or Y region"]
+
...
+
image::commonscript:galleryScatter3.png[alt="select aggregation method for measure"]
...
+
image::commonscript:galleryScatter4.png[alt="drag second measure to chart region"]
...
+
image::commonscript:galleryScatter5.png[alt="set aggregation for second measure"]
+
This creates the desired scatter chart.
+
image::commonscript:galleryScatter6.png[alt="completed scatter chart with two measures"]
...
+
image::commonscript:galleryScatter7.png[alt="scatter chart with multiple measures"]
...
image::dashboard:galleryMultipleMeasure3.png[alt="Census dashboard scatter chart example"]
