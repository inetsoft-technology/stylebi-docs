...
// metadata for AI
ifdef::ai[]
How to create a Line Chart in Visual Composer, including the stacked line variant. Best suited for showing trends over time or continuous data. Covers binding dimensions and measures to chart regions, breaking out data by color, shape, size, text, or break-by/tooltip, and setting measure aggregation. See BasicChartingSteps for general chart creation fundamentals.
endif::ai[]

A line chart displays a measure as a continuous line.

image::commonscript:lineChartExp5.png[alt="line chart example"]
...
+
image::commonscript:lineChartExp1.png[alt="press Select Chart Style button"]
+
...
+
image::commonscript:lineChartExp4.png[alt="drag dimension to X or Y region"]
...
+
image::commonscript:lineChartExp2.png[alt="drag dimension to Color region"]
...
+
image::commonscript:lineChartExp3.png[alt="drag measure to X or Y region"]
...
+
image::Chart Edit Y Axis_1.png[alt="press Edit Measure button"]
