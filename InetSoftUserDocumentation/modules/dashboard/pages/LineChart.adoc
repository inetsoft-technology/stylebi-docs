...
// metadata for AI
ifdef::ai[]
Summary: How to create a Line Chart in Visual Composer, including stacked and step-line variants. Best suited for showing trends over time or continuous data. Covers binding dimensions and measures and configuring line style options. See BasicChartingSteps for general chart creation fundamentals.
endif::ai[]
