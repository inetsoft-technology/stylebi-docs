...
// metadata for AI
ifdef::ai[]
Summary: Reference for Text component properties. Covers the Text field (static label or dynamic expression), data binding for displaying aggregate values, and formatting. The Text component can also embed external content via URL. See AddTextOrHTML for how to add a Text component.
endif::ai[]
