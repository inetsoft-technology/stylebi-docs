...
// metadata for AI
ifdef::ai[]
Summary: How end users interact with filter components in the User Portal (Selection List, Selection Tree, Range Slider, Calendar, CheckBox, RadioButton, ComboBox) at Dashboard view time — making selections, applying filters, and clearing selections. This is the end-user companion to AddFilterComponents, which covers how designers configure these components.
endif::ai[]
