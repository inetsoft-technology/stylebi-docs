...
// metadata for AI
ifdef::ai[]
Summary: Reference for Image component properties, which displays a static or dynamic image in a Dashboard. Covers image selection, transparency (Alpha), scaling options (including 9-cell grid), tiling, and the Pop Component feature for click-triggered pop-up overlays.
endif::ai[]
