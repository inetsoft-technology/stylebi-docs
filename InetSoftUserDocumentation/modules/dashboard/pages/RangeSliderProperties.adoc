...
NOTE: Range Slider has no built-in title or caption. To label a Range Slider, add a separate Text component near the Range Slider. See xref:AddTextOrHTML.adoc[].
