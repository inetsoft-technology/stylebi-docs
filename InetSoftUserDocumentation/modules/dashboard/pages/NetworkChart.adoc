...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Network chart, which displays pairwise peer relationships with nodes positioned freely. Requires Source and Target dimension fields and optionally a weight measure. An alternative to CircularNetworkChart which arranges nodes along a circle.
endif::ai[]
