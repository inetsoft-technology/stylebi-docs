...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Heat Map chart, which displays a measure using a colored grid where cell color intensity represents the aggregated value at each dimension intersection. Place dimensions on X and Y axes, and the measure in the Color region.
endif::ai[]
