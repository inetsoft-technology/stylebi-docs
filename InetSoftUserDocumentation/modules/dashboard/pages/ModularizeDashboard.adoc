...
// metadata for AI
ifdef::ai[]
Summary: Explains how to build composite Dashboards in Visual Composer by nesting smaller Dashboard modules within a parent Dashboard, and how to synchronize filter and form components across nested Dashboards using shared filter IDs. Covers reusability, maintainability, and team development benefits.
endif::ai[]
