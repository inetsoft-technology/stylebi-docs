...
+
image::commonscript:SunburstConfig3.png[alt="drag State dimension to Color region"]
...
+
image::commonscript:EditColorButton.png[alt="press Edit Color button for State dimension"]

. {finishEditing}

. Resize the chart as desired.
+
image::commonscript:SunburstConfig1.png[alt="resize completed sunburst chart"]
