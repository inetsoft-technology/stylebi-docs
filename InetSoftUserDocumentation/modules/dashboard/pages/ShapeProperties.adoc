...
// metadata for AI
ifdef::ai[]
Summary: Reference for Shape component properties (Line, Oval, Rectangle). Covers border style and color, fill color and transparency, rounded corner radius (rectangles), and gradient fills. See AddBackground for how to add shapes to a Dashboard.
endif::ai[]
