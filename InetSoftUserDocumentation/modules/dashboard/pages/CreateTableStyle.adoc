...
// metadata for AI
ifdef::ai[]
How to create, organize, and delete custom reusable Table Styles in Visual Composer that can be applied to Tables and Crosstabs across multiple Dashboards. Covers defining cell formatting for each region of the table (Header Row, Header Column, Trailer Row, Trailer Column, Body, and border regions) in the Table Style Editor. Also explains how to create Table Style folders to organize styles, delete existing styles, and create or edit custom style patterns — mathematical row/column repeat rules that apply formatting to every Nth row or column. Use when the built-in predefined styles are insufficient.
endif::ai[]
...
+
image::tableStyle1.png[alt="press Actions and select New Table Style"]
+
...
+
image::tableStyle2.png[alt="click table region to select and style it"]
+
...
+
image::tableStyle3.png[alt="press Actions and select New Folder"]
...
+
image::tableStyle4.png[alt="press Actions and select Remove"]
...
+
image::tableStyle5.png[alt="press Actions and select New Pattern"]

+
This opens the ‘Row/Column Pattern’ dialog box.
+
image::tableStyle6.png[alt="row column pattern dialog box"]
...
+
image::tableStyle7.png[alt="new pattern listed under custom patterns folder"]
...
+
image::tableStyle8.png[alt="right-click pattern and select Edit"]
+
