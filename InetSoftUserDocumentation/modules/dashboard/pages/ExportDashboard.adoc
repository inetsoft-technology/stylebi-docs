...
// metadata for AI
ifdef::ai[]
How to export a Dashboard in the User Portal as a static file (Excel, PowerPoint, PDF, HTML, PNG, CSV, Snapshot) and how to export data from individual components (Table, Crosstab, Chart). Also covers saving an individual chart as an image (SVG or PNG) via right-click, and offline editing by exporting to Excel and re-importing modified data. See also: ScheduleDashboard, which covers automated/scheduled export — for example, automatically emailing a PDF of a dashboard on a recurring basis.
endif::ai[]
...
TIP: To automatically export and email a dashboard on a recurring schedule, see xref:user:ScheduleDashboard.adoc[].
...
+
image::Viewsheet Export Content Tab_1.png[alt="select export type in export dialog"]
+
...
+
image::Crosstab Show Details.png[alt="press show details button on crosstab"]
+
This opens a panel containing the detail data.
+
image::Crosstab Show Details2.png[alt="crosstab detail data panel opened"]

. *Optional:*  To format values in the *Data* panel, press the {buttonFormat} in the header of the column you wish to format.
+
image::Crosstab Show Details Format.png[alt="press format button in data panel column header"]
+
...
+
image::Show Details Format Dialog.png[alt="format dialog box for column formatting"]
+
...
+
image::Show Details Format_2.png[alt="press table style button in data panel"]
+
...
+
image::Crosstab Show Details Export.png[alt="press export button in data panel"]
...
+
image::Table Export.png[alt="export dialog for table data"]
...
+
image::Chart Show Chart Data.png[alt="press show summary button on chart"]
+
This opens the *Data* panel.
+
image::Chart Show Chart Details2.png[alt="chart aggregate data panel opened"]

. *_Optional:_* To format values in the *Data* panel, press the {buttonFormat} in the column header that you want to format.
+
image::show Summary Format1.png[alt="press format button in chart data panel header"]
+
...
+
image::Show Details Format Dialog_1.png[alt="format type panel for chart data column"]
+
...
. To apply a global table style, press the {buttonTableStyle}.
+
image::Show Details Format_2.png[alt="press table style button in chart data panel"]
+
This opens the ‘Table Style’ dialog box. Select a table style, and press btn:[OK].
...
+
image::Chart Show Chart Data Export.png[alt="press export button in chart data panel"]
...
+
image::saveChartAsImage.png[alt="right-click chart to select save as image"]
...
. Select the *Advanced* tab, and check the ‘Enable Table Editing’ option. Select the desired editing features, ‘Add Rows’, ‘Delete Rows’, and/or ‘Edit Rows’. If you want Table edits to  persist across sessions, enable '`Write Back to Storage`'. See xref:TableProperties.adoc[] for more information about all these options.
...
+
image::Export Viewsheet Excel.png[alt="select expand components option in export dialog"]
...
. Press the {buttonApply} in each Table toolbar to save the updated information.