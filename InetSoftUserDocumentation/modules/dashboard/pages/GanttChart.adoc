...
// metadata for AI
ifdef::ai[]
How to create a Gantt chart in Visual Composer, which displays task timelines with start dates, end dates, and optional milestones. Requires date fields converted to measures and bound to Start, End, and Milestone regions, with a task dimension on the Y axis. Task order can be set manually using the Edit Dimension sort option. Milestone appearance (color and size) can be customized via the Color and Size regions.
endif::ai[]
...
image::commonscript:gantt1.png[alt="gantt chart example"]
...
image::commonscript:gantt3.png[alt="gantt chart data structure"]
====
...
+
image::commonscript:gantt2.png[alt="press Select Chart Style button"]
...
+
image::commonscript:ganttChartExpVS1.png[alt="select Convert to Measure from menu"]


. Drag the start date measure to the ‘Start’ region.
+
image::commonscript:ganttChartExpVS2.png[alt="drag start date to Start region"]

. Drag the end date measure to the ‘End’ region.
+
image::commonscript:ganttChartExpVS3.png[alt="drag end date to End region"]

. Drag the milestone date measure  to the ‘Milestone’ region.
+
image::commonscript:ganttChartExpVS4.png[alt="drag milestone to Milestone region"]
...
+
image::commonscript:ganttChartExpVS5.png[alt="drag dimension to Y region"]
+
...
+
image::commonscript:gantt9.png[alt="press Edit Dimension button"]
+
...
+
image::commonscript:ganttChartExpVS6.png[alt="press Edit Color button"]
...
+
image::commonscript:gantt10.png[alt="press Edit Size button"]
