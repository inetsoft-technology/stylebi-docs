...
// metadata for AI
ifdef::ai[]
Summary: How to create a Gantt chart in Visual Composer, which displays task timelines with start dates, end dates, and optional milestones. Requires date fields converted to measures and bound to Start, End, and Milestone regions, with a task dimension on the Y axis.
endif::ai[]
