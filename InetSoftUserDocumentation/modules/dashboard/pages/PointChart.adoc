...
// metadata for AI
ifdef::ai[]
Summary: How to create a Point chart in Visual Composer, which displays a measure as a collection of points and is the default chart style for numerical dimensions. Covers selecting the Point style, binding a dimension to Color/Shape/Size/Text regions, and adding measure fields. See BubbleChart to encode a second measure as point size, ScatterChart to place measures on both axes, or DotPlotChart to show individual un-aggregated values.
endif::ai[]
...
image::commonscript:pointChartExp5.png[alt="point chart displaying measure as collection of points"]
...
+
image::commonscript:pointChartExp1.png[alt="choose Point chart style and press Apply"]
+
...
+
image::commonscript:pointChartExp2.png[alt="drag dimension to X or Y region in Chart Editor"]
...
+
image::commonscript:pointChartExp3.png[alt="drag dimension to Color Shape Size or Text region"]
...
+
image::commonscript:pointChartExp4.png[alt="drag measure to X or Y region in Chart Editor"]
+
...
+
image::Chart Edit Y Axis_1.png[alt="select aggregation method for point chart measure"]
