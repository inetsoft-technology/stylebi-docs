...
// metadata for AI
ifdef::ai[]
Summary: Explains how end-users interact with charts at runtime, including using the chart toolbar, zooming, drilling down into data, and saving chart changes via bookmarks, image export, or Dashboard save. Available to end-users viewing Dashboards in the Portal.
endif::ai[]
