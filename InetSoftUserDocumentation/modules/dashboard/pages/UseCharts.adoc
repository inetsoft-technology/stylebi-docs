...
// metadata for AI
ifdef::ai[]
Summary: Explains how end-users interact with charts at runtime in the User Portal, including using the chart toolbar, zooming, drilling down into data, and saving chart changes via bookmarks, image export, or Dashboard save.
endif::ai[]
