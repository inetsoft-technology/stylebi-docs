...
// metadata for AI
ifdef::ai[]
Summary: Explains how to apply trend and comparison methods in Visual Composer to Chart or Crosstab measures, such as percent of total, change from previous group, moving averages (including trend lines and comparison lines), and running totals. These methods are set via the Trend and Comparison option in the Edit Measure panel.
endif::ai[]
