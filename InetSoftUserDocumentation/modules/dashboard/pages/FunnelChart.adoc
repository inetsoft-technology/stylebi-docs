...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Funnel chart, which displays sequential process stages as horizontally proportional bars arranged in descending order. Dimensions represent stages (Y region) and measures represent stage sizes (X region).
endif::ai[]
