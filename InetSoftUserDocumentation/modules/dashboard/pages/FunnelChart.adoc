...
// metadata for AI
ifdef::ai[]
Summary: How to create a Funnel chart in Visual Composer, which displays sequential process stages as horizontally proportional bars arranged in descending order. Dimensions represent stages (Y region) and measures represent stage sizes (X region).
endif::ai[]
