...
// metadata for AI
ifdef::ai[]
Summary: Explains how to save (also called publish) a Dashboard in Visual Composer to either a public location (accessible to all users with read permission) or a private location (creator-only). Covers Save vs. Save As and the requirement for write permission. To make a saved Dashboard visible in the User Portal, also enable List on Portal Tree in DashboardOptions.adoc. For a full overview of publishing options, see PublishDashboard.adoc.
endif::ai[]
...
+
image::dashboard:viewsheetExp10.png[alt="save dashboard to public location"]
+
