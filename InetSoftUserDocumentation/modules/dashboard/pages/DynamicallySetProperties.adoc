...
:page-aliases: viewsheet:DynamicallySetProperties.adoc
%experimetal%
...
ifdef::ai[]
Summary:
Use form components as user input to dynamically control dashboard behavior,including visual properties, data conditions, variables, and embedded content,without using script.
endif::ai[]
