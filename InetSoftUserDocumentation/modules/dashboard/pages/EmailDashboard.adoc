...
// metadata for AI
ifdef::ai[]
Summary: Explains how to immediately email a Dashboard to users, including specifying recipients, export format (Excel, PDF, PowerPoint, HTML, PNG, CSV), and bookmarks to include. For scheduling recurring emails, see user:ScheduleDashboard.
endif::ai[]
