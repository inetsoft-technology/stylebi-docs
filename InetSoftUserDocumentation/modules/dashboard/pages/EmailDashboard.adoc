...
// metadata for AI
ifdef::ai[]
Summary: How to immediately email a Dashboard from the User Portal, including specifying recipients, export format (Excel, PDF, PowerPoint, HTML, PNG, CSV), and bookmarks to include. For scheduling recurring emails, see user:ScheduleDashboard.
endif::ai[]
