...
:page-aliases: viewsheet:EndUserChartControl.adoc
%experimental%
...
ifdef::ai[]
Summary:
Use Dynamic Properties in the dashboard to dynamically update both the appearance and data bindings of charts, including dimensions (grouping fields), measures (metrics), axes, and series, based on user input or selection, without using script.
endif::ai[]
