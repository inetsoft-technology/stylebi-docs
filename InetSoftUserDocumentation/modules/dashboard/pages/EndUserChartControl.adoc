...
// metadata for AI
ifdef::ai[]
Summary: How to allow end users to modify charts at runtime, configured in Visual Composer using two approaches: the Ad Hoc Chart Editor (enabled via 'Enable Ad Hoc Editing' in Chart Properties) or dynamic properties (linking Form components such as RadioButton to chart fields and aggregation methods via the Variable option). See DynamicallySetProperties for full details on dynamic property configuration.
endif::ai[]
