...
// metadata for AI
ifdef::ai[]
Summary: How to create a Box (box-and-whisker) chart in Visual Composer, which displays a measure's distribution in terms of median, minimum, maximum, first and third quartiles, with individual outliers shown as separate points. Covers binding a dimension and measure to the chart and choosing the Box Plot style.
endif::ai[]

A box chart (also known as “box-and-whisker” plot) displays a measure in terms of its median, minimum, maximum, first quartile, and third quartile (excluding outliers).

image::commonscript:boxChartExp4.png[alt="box chart example"]
...
+
image::commonscript:boxChartExp1.png[alt="select Box Plot chart style"]
...
+
image::commonscript:BoxChartExp5b.png[alt="drag dimension to X or Y"]
+
...
+
image::commonscript:boxChartExp3.png[alt="drag measure to X or Y"]
+
