...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Box (box-and-whisker) chart, which displays a measure's distribution in terms of median, minimum, maximum, first and third quartiles, with individual outliers shown as separate points. Covers binding a dimension and measure to the chart and choosing the Box Plot style.
endif::ai[]
