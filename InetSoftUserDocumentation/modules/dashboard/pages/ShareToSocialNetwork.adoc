...
// metadata for AI
ifdef::ai[]
Summary: How end users can share a Dashboard to social networks (LinkedIn, Twitter, Facebook, etc.) or via email in the User Portal using the Social Sharing button in the Dashboard toolbar. Access to sharing options is controlled by administrator permissions. See SetSecurityActions to configure which sharing options are available.
endif::ai[]
...
+
image::socialButton.png[alt="press Social Sharing button on toolbar"]
...
+
image::socialEmail.png[alt="select Email button opens email dialog"]
...
+
image::socialCopyLink.png[alt="select Copy Link opens copy link dialog"]
