...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Donut chart, which is a PieChart with a hole in the center. The hole can be empty (simple donut) or display a KPI value such as a grand total (advanced donut). See PieChart for basic pie chart creation.
endif::ai[]
