...
+
image::commonscript:TreemapConfig3.png[alt="drag State dimension to Color region"]
...
+
image::commonscript:TreemapConfig1.png[alt="resize completed treemap chart"]
