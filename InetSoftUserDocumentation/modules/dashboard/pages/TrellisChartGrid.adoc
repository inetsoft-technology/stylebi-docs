...
// metadata for AI
ifdef::ai[]
Summary: Explains how to create a Trellis chart grid in Visual Composer (also called small multiples or a faceted chart), which is a grid of charts where each cell represents a different dimension value. Place dimensions in the X and/or Y regions of the Chart Editor to create the grid. Note that web map backgrounds are not supported in trellis charts.
endif::ai[]
...
image::commonscript:chart2_1.png[alt="grid of charts by region and category"]
...
image::commonscript:chart3_1.png[alt="place dimensions in X and Y regions for grid"]
...
image::dashboard:galleryMap2.png[alt="grid of line charts example"]
