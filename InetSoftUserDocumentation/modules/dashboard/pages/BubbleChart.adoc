...
// metadata for AI
ifdef::ai[]
Summary: How to create a Bubble chart in Visual Composer, which is a Point chart where the size of each point represents a second measure. Use the Size region for the size measure, and optionally Color and Shape regions for additional visual encoding.
endif::ai[]
...
image::dashboard:galleryBubble2.png[alt="bubble chart dashboard example"]
