...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Circular Network chart, which displays pairwise peer relationships with nodes arranged along a circle circumference. Requires Source and Target dimension fields. An alternative layout to NetworkChart.
endif::ai[]
