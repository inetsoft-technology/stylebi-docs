...
// metadata for AI
ifdef::ai[]
Summary: How to create a Circular Network chart in Visual Composer, which displays pairwise peer relationships with nodes arranged along a circle circumference. Requires Source and Target dimension fields. An alternative layout to NetworkChart.
endif::ai[]
