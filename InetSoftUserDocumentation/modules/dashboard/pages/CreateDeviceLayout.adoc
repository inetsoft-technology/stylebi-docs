...
// metadata for AI
ifdef::ai[]
Summary: How to create device-specific layouts for a Dashboard in Visual Composer to control how it appears on mobile devices, tablets, and printed pages. Covers adding device layouts, repositioning and resizing components per layout, and setting print layout options. Permission to edit device layouts is controlled by administrator settings.
endif::ai[]
