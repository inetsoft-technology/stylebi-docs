...
:page-aliases: viewsheet:CreateDeviceLayout.adoc
%experimetal%
...
====
StyleBI does not have a separate "`report`" asset -- what other products call a report is simply a Dashboard. A *print layout* is how you get the same paginated, multi-page output a report used to provide: page breaks, page numbering, and headers/footers that repeat identically on every printed page.
====
