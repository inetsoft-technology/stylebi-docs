...
// metadata for AI
ifdef::ai[]
Summary: How to add and configure a Crosstab (also called a pivot table or cross-tab) in a Dashboard in Visual Composer. Crosstabs aggregate data across row and column dimensions, displaying subtotals and grand totals. Use a Crosstab when you need to summarize measures broken down by two or more dimensions in a tabular format.
endif::ai[]
