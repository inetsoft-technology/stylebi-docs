...
// metadata for AI
ifdef::ai[]
Summary: How to add and configure a Table in Visual Composer, including styling, resizing, aligning, and formatting columns. Most of these operations—especially applying Table Styles—also apply to Crosstab and Freehand table, ensuring consistent formatting across all table types.
endif::ai[]
