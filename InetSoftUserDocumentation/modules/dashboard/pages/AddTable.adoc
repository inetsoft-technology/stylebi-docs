...
// metadata for AI
ifdef::ai[]
How to add and configure a Table in Visual Composer, including binding data columns, hiding or sorting columns, applying Table Styles, resizing the table and its columns, aligning header and data cells, and formatting columns as currency, date, or number. Also covers reordering columns.
endif::ai[]
