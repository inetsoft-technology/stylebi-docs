...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating an Interval chart in Visual Composer, which is a bar chart variant where each bar spans between two measure values — a lower bound (Y region) and a height/span (Size region). Useful for displaying confidence intervals, ranges, or two-measure comparisons.
endif::ai[]
...
image::commonscript:intervalChartExp0.png[alt="interval chart example"]
...
+
image::commonscript:intervalChartExp1.png[alt="press Select Chart Style button"]
...
+
image::commonscript:intervalChartExp2.png[alt="drag dimension to X region"]
...
+
image::viewsheetExp34.png[alt="press Edit Dimension button"]
...
+
image::commonscript:intervalChartExp4.png[alt="drag measure to Y region"]
+
...
+
image::commonscript:intervalChartExp5.png[alt="press Edit Measure button"]
...
+
image::commonscript:intervalChartExp6.png[alt="drag measure to Size region"]


. Press the {buttonEditMeasure} next to the ‘Size’  measure, and select the desired aggregation method for the measure.
+
image::commonscript:intervalChartExp7.png[alt="press Edit Measure button"]
+
...
+
image::commonscript:intervalChartExp8.png[alt="interval chart with lower and size measures"]
