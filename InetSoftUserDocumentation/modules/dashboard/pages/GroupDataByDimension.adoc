...
[square]
* If no field is bound in  the '`Color`' region, you can set the Size legend symbol color  using the '`Edit Color`' button next to the '`Color`' region.
