...
// metadata for AI
ifdef::ai[]
Summary: How to create a Pareto chart in Visual Composer, which combines a descending bar chart with a cumulative percentage line to highlight the top contributors to a total. The left axis shows actual values; the right axis shows cumulative percentage. Covers selecting the Pareto style, binding a dimension and measure, and setting the aggregation method.
endif::ai[]
...
image::dashboard:galleryBar2.png[alt="Auto Insurance Overview Pareto chart dashboard sample"]
