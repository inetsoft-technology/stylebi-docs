...
// metadata for AI
ifdef::ai[]
Summary: How to create a Pareto chart in a Dashboard, which combines a descending bar chart with a cumulative percentage line to highlight the top contributors to a total. The left axis shows actual values; the right axis shows cumulative percentage. Covers selecting the Pareto style, binding a dimension and measure, and setting the aggregation method.
endif::ai[]
