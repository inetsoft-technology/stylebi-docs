...
// metadata for AI
ifdef::ai[]
Summary: Reference for creating a Pareto chart, which combines a descending bar chart with a cumulative percentage line to highlight the top contributors to a total. The left axis shows actual values; the right axis shows cumulative percentage.
endif::ai[]
