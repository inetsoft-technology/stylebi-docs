...
// metadata for AI
ifdef::ai[]
Summary: Overview of all drill-down techniques available in a Dashboard in Visual Composer, including chart brushing (cross-chart filter or linked selection), hyperlinks, flyover views (hover tooltips), and dimension-level drilling. Most techniques are available to end users at view time. Use this page to choose the right approach for interactive data exploration and navigation between detail levels.
endif::ai[]
