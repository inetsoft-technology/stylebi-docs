...
// metadata for AI
ifdef::ai[]
Summary: How to create a geographic Map Chart in Visual Composer, including built-in maps (world, US states, etc.) and custom maps. Covers binding geographic name or coordinate fields, adding color and size encodings for measures, and configuring map layers. Use when you need to visualize data by geographic region or location.
endif::ai[]
