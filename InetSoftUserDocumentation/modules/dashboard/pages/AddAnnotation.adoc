...
// metadata for AI
ifdef::ai[]
How to add, reposition, format, and edit text annotations (also called comments, notes, or data notes) in a Dashboard. Annotations can be attached to the Dashboard body, to a specific component, to an individual data point in a Chart, or to an individual cell in a Table. Annotations can be hidden (shown as a small note icon) or shown via a toolbar button; visible annotations are included when a Dashboard is exported. Annotations are saved per bookmark and are available to end users (not just designers) at view time. They allow a user to "mark up" a Dashboard.
endif::ai[]
...
+
image::AnnotationViewsheet1_1.png[alt="right-click dashboard and select Add Annotation"]
...
+
image::AnnotationViewsheet2_2.png[alt="enter annotation text in editor"]

. Press btn:[OK] to close the Annotation Editor. This adds the annotation to the Dashboard.
+
image::AnnotationViewsheet3_1.png[alt="annotation added to dashboard"]
...
+
image::AnnotationComponent1_1.png[alt="right-click component and select Annotate Component"]
+
...
. Enter the desired annotation text into the Editor, and use the formatting tools in the toolbar to adjust the font, size, weight, color, etc.
+
image::AnnotationComponent3_1.png[alt="enter annotation text and format in editor"]
...
+
image::AnnotationComponent4_1.png[alt="annotation added with callout line to component"]
...
+
image::AnnotationPoint1.png[alt="right-click chart data point, select Annotate Point"]
+
This opens the Annotation Editor, which displays the contents of the current data point tooltip.
+
image::AnnotationPoint2.png[alt="annotation editor with data point tooltip contents"]

. Enter the desired annotation text into the Editor, and use the formatting tools in the toolbar to adjust the font, size, weight, color, etc.
+
image::AnnotationPoint3.png[alt="enter annotation text for data point"]
...
+
image::AnnotationPoint4.png[alt="annotation added with callout line to data point"]
...
+
image::AnnotationComponent1_1.png[alt="right-click table cell and select Annotate Cell"]
+
This opens the Annotation Editor, which by default displays the contents of the current cell’s tooltip.
+
image::AnnotationCell2_1.png[alt="annotation editor with cell tooltip contents"]

. Enter the desired annotation text into the Editor, and use the formatting tools in the toolbar to adjust the font, size, weight, color, etc.
+
image::AnnotationCell3_1.png[alt="enter annotation text for table cell"]
...
+
image::AnnotationCell4_1.png[alt="annotation added with callout line to table cell"]
...
== Edit an  Annotation
include::dashboard:partial$annotationEditing.adoc[]
...
include::dashboard:partial$annotationPosition.adoc[]
...
image::AnnotationHidden_1.png[alt="hidden annotation shown as note icon"]
...
+
image::AnnotationShow.png[alt="press Show Annotations button in toolbar"]
+
