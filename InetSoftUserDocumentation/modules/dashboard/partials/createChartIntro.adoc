...
Follow the steps below to get started with a new Chart.  See xref:dashboard:BasicChartingSteps.adoc[] for more details.
...
+
image:addingChart.png[alt="drag Chart component into Dashboard"]

. Resize the Chart as desired by dragging the handles.
+
image:resizeChartHandle_1.png[alt="drag handles to resize Chart"]

. Press the ’Edit’ button in the center of the Chart or press the {buttonEdit} in the top-right corner.
+
image:ChartEditButton.png[alt="press Edit button on Chart"]
+
...
+
image:ChartEditorIntro.png[alt="press Full Editor to open Chart Editor"]
====