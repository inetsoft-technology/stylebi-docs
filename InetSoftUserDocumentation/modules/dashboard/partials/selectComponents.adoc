...
image::dashboard:Move Handle_1.png[alt="component move and resize handles"]
...
image::dashboard:Drag Select Multiple Components.png[alt="drag mouse to select multiple components"]
