...
image:AnnotationViewsheet4_1.png[alt="drag resize handle to resize annotation"]

To move the annotation, click-and-drag on the “move” handle, or click and drag on the annotation body.

image:AnnotationViewsheet5_1.png[alt="drag move handle to reposition annotation"]
