...
// metadata for AI
ifdef::ai[]
Summary: Returns the *nominal* annual interest rate, given the effective compounded rate and the number of compounding periods per year. {CALCExcelFunctionPage}
endif::ai[]
