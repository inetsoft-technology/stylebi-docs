...
// metadata for AI
ifdef::ai[]
Summary: JavaScript function to return the year of a date in universal time. See https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/getUTCFullYear[Date.getUTCFullYear()] in the {JavaScriptRef} for details on usage.
endif::ai[]
