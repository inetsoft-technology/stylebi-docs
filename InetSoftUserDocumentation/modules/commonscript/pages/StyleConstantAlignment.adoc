...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboardscript:CommonAlignment.adoc[] for information about using alignment constants.
endif::ai[]

[WARNING,caption=see also]
xref:dashboardscript:CommonAlignment.adoc[] for information about using alignment constants.
