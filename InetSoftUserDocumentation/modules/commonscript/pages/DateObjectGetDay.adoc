...
// metadata for AI
ifdef::ai[]
Summary: JavaScript function to return the day of the week (with Sunday having index 0) corresponding to the Date object. See https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/getDay[Date.getDay()] in the {JavaScriptRef} for details on usage.
endif::ai[]
