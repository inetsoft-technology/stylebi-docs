...
// metadata for AI
ifdef::ai[]
Summary: Overview of LiveConnect support in the InetSoft scripting engine, which allows JavaScript scripts to access Java classes and objects using the new operator.
endif::ai[]
