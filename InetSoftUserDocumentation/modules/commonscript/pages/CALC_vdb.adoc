...
// metadata for AI
ifdef::ai[]
Summary: Returns the depreciation of an asset over an arbitrary period using the *variable-declining balance* method. The rate of depreciation for a given year is `factor/life`.
endif::ai[]
