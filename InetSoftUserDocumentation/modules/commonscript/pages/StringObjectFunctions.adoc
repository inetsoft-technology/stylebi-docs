...
// metadata for AI
ifdef::ai[]
Summary: String is a built-in type in JavaScript. It holds a sequence of characters in the Unicode character set. A string literal is created using a double quote or a single quote strings.
endif::ai[]
