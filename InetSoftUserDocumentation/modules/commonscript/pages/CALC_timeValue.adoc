...
// metadata for AI
ifdef::ai[]
Summary: Returns a decimal between 0 and 1 representing the time in the specified date object as a fraction of the 24-hour day. For example, time 0:00 has value 0.0, while time 12:00 has value 0.5. {CALCExcelFunctionPage}
endif::ai[]
