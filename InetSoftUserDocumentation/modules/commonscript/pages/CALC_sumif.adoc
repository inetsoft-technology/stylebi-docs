...
// metadata for AI
ifdef::ai[]
Summary: Returns the sum of the elements in `array2` corresponding to elements in `array1` that satisfy the condition given by `conditionString`. {CALCExcelFunctionPage}
endif::ai[]
