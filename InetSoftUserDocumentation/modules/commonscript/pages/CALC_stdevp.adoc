...
// metadata for AI
ifdef::ai[]
Summary: Returns the *population standard deviation* for the values in `array`. Standard deviation is the square root of the variance and provides a measure of how widely the data are spread about the mean. {CALCExcelFunctionPage}
endif::ai[]
