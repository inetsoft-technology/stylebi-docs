...
// metadata for AI
ifdef::ai[]
Summary: JavaScript function to set the hours part of a date in universal time. See https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/setUTCHours[Date.setUTCHours()] in the {JavaScriptRef} for details on usage.
endif::ai[]
