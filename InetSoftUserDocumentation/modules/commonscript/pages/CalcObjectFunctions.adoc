...
// metadata for AI
ifdef::ai[]
Summary: Overview and navigation page for the CALC object function library, which provides static implementations of Microsoft Excel spreadsheet functions for use in scripting without creating a CALC instance.
endif::ai[]
