...
// metadata for AI
ifdef::ai[]
Summary: Returns the smallest value in array, where Booleans are valued as 1 if `true` and 0 if false, and string values are valued as 0. {CALCExcelFunctionPage}
endif::ai[]
