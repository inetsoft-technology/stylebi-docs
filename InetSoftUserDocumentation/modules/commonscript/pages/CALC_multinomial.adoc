...
// metadata for AI
ifdef::ai[]
Summary: Returns the ratio of the factorial of a sum of values to the product of their factorials. For `array` of three numbers stem:[[a, b, c\]], the multinomial is given by
endif::ai[]
