...
// metadata for AI
ifdef::ai[]
Summary: Returns the number of possible permutations in which `number_chosen` objects can be selected from `number` of objects, where order is significant. {CALCExcelFunctionPage}
endif::ai[]
