...
// metadata for AI
ifdef::ai[]
Summary: Overview and navigation page for JavaScript Date object functions, covering how to create and manipulate Date objects for date/time operations and conversions in the scripting environment.
endif::ai[]
