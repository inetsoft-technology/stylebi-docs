...
// metadata for AI
ifdef::ai[]
Summary: JavaScript function to set the minutes part of a date in universal time. See https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/setUTCMinutes[Date.setUTCMinutes()] in the {JavaScriptRef} for details on usage.
endif::ai[]
