...
// metadata for AI
ifdef::ai[]
Summary: Constructor for a JavaScript Date object. See https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date[Date()] in the {JavaScriptRef} for details on usage.
endif::ai[]
