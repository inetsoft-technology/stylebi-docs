...
// metadata for AI
ifdef::ai[]
Summary: JavaScript function to return the minutes part of a date in universal time. See https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/getUTCMinutes[Date.getUTCMinutes()] in the {JavaScriptRef} for details on usage.
endif::ai[]
