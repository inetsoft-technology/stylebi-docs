...
// metadata for AI
ifdef::ai[]
Summary: Returns the capital in a given period’s *payment* for an investment based on *periodic* constant payments and a constant interest rate. {CALCExcelFunctionPage}
endif::ai[]
