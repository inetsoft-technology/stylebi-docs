...
// metadata for AI
ifdef::ai[]
Summary: Formats a number according to the format string.
endif::ai[]
...
[%collapsible]
====
For examples of how  to construct formats using these symbols, see xref:dashboard:DataFormat.adoc#NumberFormat[Number Format] in xref:dashboard:VisualizeYourData.adoc[].
