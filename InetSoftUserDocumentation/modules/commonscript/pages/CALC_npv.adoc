...
// metadata for AI
ifdef::ai[]
Summary: Returns the *net present value* of an investment by using a discount rate and a series of future payments (negative values) and income (positive values). {CALCExcelFunctionPage}
endif::ai[]
