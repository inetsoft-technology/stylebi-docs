...
// metadata for AI
ifdef::ai[]
Summary: Returns the rank of `number` within the values in `array`. The rank is the position of the value in the list after sorting in ascending or descending order. {CALCExcelFunctionPage}
endif::ai[]
