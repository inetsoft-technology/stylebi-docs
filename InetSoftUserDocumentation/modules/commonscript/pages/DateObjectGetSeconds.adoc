...
// metadata for AI
ifdef::ai[]
Summary: JavaScript function to return the seconds part of a date. See https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/getSeconds[Date.getSeconds()] in the {JavaScriptRef} for details on usage.
endif::ai[]
