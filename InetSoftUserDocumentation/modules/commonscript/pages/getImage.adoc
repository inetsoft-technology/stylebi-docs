...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboardscript:ChangeImageWithScript.adoc[] for another approach to dynamically change images in a Dashboard.
endif::ai[]

[WARNING,caption=see also]
xref:dashboardscript:ChangeImageWithScript.adoc[] for another approach to dynamically change images in a Dashboard.
