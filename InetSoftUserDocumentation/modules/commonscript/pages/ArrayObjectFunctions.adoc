...
// metadata for AI
ifdef::ai[]
Summary: Overview and navigation page for JavaScript Array object functions, covering the built-in methods for creating and manipulating non-fixed-length arrays in the scripting environment.
endif::ai[]
