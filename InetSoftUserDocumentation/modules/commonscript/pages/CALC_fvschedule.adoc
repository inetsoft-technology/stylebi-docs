...
// metadata for AI
ifdef::ai[]
Summary: Returns the *future value* of an initial principal after applying a specified series of compound interest rates. Use this function to calculate the future value of an investment with a variable or adjustable rate. {CALCExcelFunctionPage}
endif::ai[]
