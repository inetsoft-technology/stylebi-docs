...
// metadata for AI
ifdef::ai[]
Summary: JavaScript function to set the day of the month for a date in universal time. See https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/setUTCDate[Date.setUTCDate()] in the {JavaScriptRef} for details on usage.
endif::ai[]
