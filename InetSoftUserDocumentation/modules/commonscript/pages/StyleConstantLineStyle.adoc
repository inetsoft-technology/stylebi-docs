...
// metadata for AI
ifdef::ai[]
Summary: The line style constants can be used in all properties requiring line style constants, such as separator style, tab fill style, and table borders.
endif::ai[]
