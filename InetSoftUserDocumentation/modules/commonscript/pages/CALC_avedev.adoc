...
// metadata for AI
ifdef::ai[]
Summary: Returns the average of the absolute deviations from mean of data in `array`. This is a measure of the variability in the data set. {CALCExcelFunctionPage}
endif::ai[]
