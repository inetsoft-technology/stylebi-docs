...
// metadata for AI
ifdef::ai[]
Summary: Returns the *interest* paid during a given period for a fixed-rate investment in which a constant amount of the principal is paid at the start of each period. This function is provided for compatibility with Lotus 1-2-3. {CALCExcelFunctionPage}
endif::ai[]
