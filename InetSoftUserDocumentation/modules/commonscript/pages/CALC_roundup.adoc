...
// metadata for AI
ifdef::ai[]
Summary: Rounds a number away from zero to a specified number of digits. Positive number are rounded up, negative numbers are rounded down. {CALCExcelFunctionPage}
endif::ai[]
