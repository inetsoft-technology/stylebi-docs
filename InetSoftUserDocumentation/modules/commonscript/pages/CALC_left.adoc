...
// metadata for AI
ifdef::ai[]
Summary: Returns `num_char` number of characters from the *left side* of `string`. {CALCExcelFunctionPage} To extract a substring with arbitrary starting and ending indexes, use xref:StringObjectsubString.adoc[] or xref:CALC_mid.adoc[].
endif::ai[]
