...
// metadata for AI
ifdef::ai[]
Summary: Returns the *sample variance* for the values in `array`, which can include Boolean values. Variance is the square of the standard deviation and provides a measure of how widely the data are spread about the mean. {CALCExcelFunctionPage}
endif::ai[]
