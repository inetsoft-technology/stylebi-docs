...
image:viewsheet:NewCalculatedField1.png[alt="new calculated field dialog after right-clicking a data block"]
...
image:viewsheet:CalcField1.png[alt="calculated field formula entered in the formula editor"]
====
...
image:viewsheet:expressionData.png[alt="expression referencing component data using selectedObjects property"]
...
image:viewsheet:ScriptComponentData.png[alt="script accessing component data using table property syntax"]
