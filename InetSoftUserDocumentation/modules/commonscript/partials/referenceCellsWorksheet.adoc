...
CATEGORY_ID
+
image:dataworksheet:ReferenceCellExampleMakeTable6.png[alt="PRODUCTS data block with PRODUCT_ID, PRODUCT_NAME, CATEGORY_ID fields"]
...
+
image:dataworksheet:ReferenceCellExampleMakeTableNoSQL.png[alt="formula editor with script button selected and cell reference formula entered"]
...
+
image:dataworksheet:ReferenceCellExampleMakeTable7.png[alt="PRODUCTS1 and CATEGORIES1 data blocks linked by graphical reference line"]
...
+
image:dataworksheet:ReferenceCellExampleMakeTable5.png[alt="PRODUCTS1 data block preview showing category name expression column"]
