...
// metadata for AI
ifdef::ai[]
Summary: Reference for the three types of scheduler task actions (Dashboard, Backup, Batch) that define operations performed when a scheduled task runs. See CreateScheduledTask.
endif::ai[]
