...
// metadata for AI
ifdef::ai[]
Summary: Reference for the configuration directory (var/lib/inetsoft/config) structure and key configuration files including inetsoft.yaml, with links to storage and audit configuration.
endif::ai[]
