...
// metadata for AI
ifdef::ai[]
Summary: How to register locales in Enterprise Manager so they appear in the language selection menus of the User Portal and Enterprise Manager login screens.
endif::ai[]
...
+
image::Figure 8.png[alt="localization page with registered locale entries"]
