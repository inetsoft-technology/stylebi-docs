...
// metadata for AI
ifdef::ai[]
Summary: How to automate InetSoft administration and deployment tasks using the Groovy DSL that wraps the public client API. Covers available built-in command-line administration functions including repository connection, data source management, scheduling, and security configuration. Enterprise only.
endif::ai[]
