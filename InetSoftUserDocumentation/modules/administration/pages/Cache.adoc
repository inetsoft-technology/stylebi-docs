...
// metadata for AI
ifdef::ai[]
Summary: How to configure the internal cache that stores Dashboard objects and datasets, including cache size, expiration, and related options in Enterprise Manager.
endif::ai[]
