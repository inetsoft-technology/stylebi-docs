...
// metadata for AI
ifdef::ai[]
Summary: How to configure the internal cache that stores Dashboard objects and datasets, including cache size, expiration, and related options in Enterprise Manager. Related to materialized views and query caching for performance tuning.
endif::ai[]
