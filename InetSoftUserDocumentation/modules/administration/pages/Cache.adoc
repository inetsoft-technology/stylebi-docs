...
// metadata for AI
ifdef::ai[]
Summary: How to configure the internal cache in Enterprise Manager, including setting the cache directory location and enabling the option to clean the cache on server startup. Additional performance settings related to caching are covered in the Server Performance page.
endif::ai[]
...
+
image::Cache Config.png[alt="open Caching page in General settings"]
