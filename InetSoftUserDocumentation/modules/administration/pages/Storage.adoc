...
// metadata for AI
ifdef::ai[]
Summary: How to configure asset storage backend in Enterprise Manager via docker-compose.yaml, covering supported storage types and migration between environments.
endif::ai[]
