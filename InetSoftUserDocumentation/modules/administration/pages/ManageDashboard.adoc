...
// metadata for AI
ifdef::ai[]
Summary: How to manage Dashboards programmatically using the Groovy DSL Administration Console :viewsheet command. Enterprise only. See CreateNewDashboard for Portal-based creation.
endif::ai[]
