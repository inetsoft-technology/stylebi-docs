...
// metadata for AI
ifdef::ai[]
Summary: How to configure authentication and authorization providers in Enterprise Manager, including Default, LDAP, Database, and Custom provider types.
endif::ai[]
...
+
image::Figure 23_1.png[alt="enable security on Security page"]
