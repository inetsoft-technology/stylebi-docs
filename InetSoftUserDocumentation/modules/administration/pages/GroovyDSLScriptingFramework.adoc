...
// metadata for AI
ifdef::ai[]
Summary: How to use the Groovy DSL scripting framework to write administrative scripts for managing repositories, data sources, security, and other server resources. Enterprise only.
endif::ai[]
...
[source,groovy]
inetsoft {
    scriptFile = commandLine[0]
    firstArg = commandLine[1]
    secondArg = commandLine[2]
...
|dataSource| https://www.inetsoft.com/docs/stylebi/apidoc/enterprise/inetsoft/enterprise/client/DataSourceClientService.html[inetsoft.enterprise.client.DataSourceClientService]
|file|  https://www.inetsoft.com/docs/stylebi/apidoc/enterprise/inetsoft/enterprise/client/FileClientService.html[inetsoft.enterprise.client.FileClientService]
|schedule|  https://www.inetsoft.com/docs/stylebi/apidoc/enterprise/inetsoft/enterprise/client/ScheduleClientService.html[inetsoft.enterprise.client.ScheduleClientService]
|security|  https://www.inetsoft.com/docs/stylebi/apidoc/enterprise/inetsoft/enterprise/client/SecurityClientService.html[inetsoft.enterprise.client.SecurityClientService]
|===
...
|jdbc| https://www.inetsoft.com/docs/stylebi/apidoc/enterprise/inetsoft/enterprise/web/api/datasource/JdbcDataSourceProperties.html[inetsoft.enterprise.web.api.datasource.JdbcDataSourceProperties]
|tabular| https://www.inetsoft.com/docs/stylebi/apidoc/enterprise/inetsoft/enterprise/web/api/datasource/TabularDataSourceProperties.html[inetsoft.enterprise.web.api.datasource.TabularDataSourceProperties]
|parameter| https://www.inetsoft.com/docs/stylebi/apidoc/enterprise/inetsoft/enterprise/web/api/report/ReportParameter.html[inetsoft.enterprise.web.api.report.ReportParameter]
|permission| https://www.inetsoft.com/docs/stylebi/apidoc/enterprise/inetsoft/enterprise/web/api/report/PermissionGrant.html[inetsoft.enterprise.web.api.report.PermissionGrant]
|task| https://www.inetsoft.com/docs/stylebi/apidoc/enterprise/inetsoft/enterprise/web/api/schedule/ScheduleTask.html[inetsoft.enterprise.web.api.schedule.ScheduleTask]
|timeCondition| https://www.inetsoft.com/docs/stylebi/apidoc/enterprise/inetsoft/enterprise/web/api/schedule/TimeCondition.html[inetsoft.enterprise.web.api.schedule.TimeCondition]
|completionCondition| https://www.inetsoft.com/docs/stylebi/apidoc/enterprise/inetsoft/enterprise/web/api/schedule/CompletionCondition.html[inetsoft.enterprise.web.api.schedule.CompletionCondition]
|viewsheetAction| https://www.inetsoft.com/docs/stylebi/apidoc/enterprise/inetsoft/enterprise/web/api/schedule/ViewsheetAction.html[inetsoft.enterprise.web.api.schedule.ViewsheetAction]
|===
