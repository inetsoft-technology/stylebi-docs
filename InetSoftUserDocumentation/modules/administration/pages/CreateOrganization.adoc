...
// metadata for AI
ifdef::ai[]
Summary: How to create a tenant organization in Enterprise Manager for multi-tenant deployments, including assigning users and configuring org-specific access. Enterprise only.
endif::ai[]
