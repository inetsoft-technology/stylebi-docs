...
// metadata for AI
ifdef::ai[]
Summary: How to configure Docker container memory and JVM options using JAVA_MEMORY_OPTS and JAVA_TOOL_OPTIONS environment variables in docker-compose.yaml, including Linux and Windows/WSL memory constraints.
endif::ai[]
