...
// metadata for AI
ifdef::ai[]
Summary: How to configure JVM memory and Docker container memory settings using JAVA_MEMORY_OPTS and related environment variables in docker-compose.yaml.
endif::ai[]
