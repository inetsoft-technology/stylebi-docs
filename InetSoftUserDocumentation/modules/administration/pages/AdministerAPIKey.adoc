...
// metadata for AI
ifdef::ai[]
Summary: How to create and manage OAuth API keys in Enterprise Manager for data sources that require OAuth authentication. Community edition only. See the list of OAuth-dependent data sources.
endif::ai[]
...
+
image::APIKey4.png[alt="press Edit button below API key"]

. Enter a new API Key and press btn:[Save].
+
image::APIKey3.png[alt="enter new API key and save"]
