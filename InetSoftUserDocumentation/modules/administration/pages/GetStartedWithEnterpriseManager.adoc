...
// metadata for AI
ifdef::ai[]
Summary: Overview and navigation page for server configuration using Enterprise Manager, covering launch, navigation, security, scheduling, repository, monitoring, and performance settings.
endif::ai[]
