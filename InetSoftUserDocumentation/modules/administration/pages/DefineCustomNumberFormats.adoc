...
// metadata for AI
ifdef::ai[]
Summary: How to define custom number formats in Enterprise Manager, including using K, M, B suffixes to scale values and creating reusable format patterns for Dashboard number display.
endif::ai[]
...
image::viewsheet:Format Number KMB.png[alt="number format with K M B suffix options"]
