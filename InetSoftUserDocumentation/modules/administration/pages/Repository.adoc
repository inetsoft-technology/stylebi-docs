...
// metadata for AI
ifdef::ai[]
Summary: How to manage the server repository in Enterprise Manager, including organizing Dashboards into folders and setting read/write permissions by user or role.
endif::ai[]
