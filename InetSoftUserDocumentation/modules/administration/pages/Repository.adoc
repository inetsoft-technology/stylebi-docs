...
// metadata for AI
ifdef::ai[]
Summary: How to manage the repository in Enterprise Manager, covering sorting repository assets, creating folders, deleting and restoring assets, configuring Dashboard properties and security, pinning Portal Dashboards for users, and managing Data Worksheet properties.
endif::ai[]
...
. To add a Dashboard *for all users*, select the ‘Portal Dashboard Tab’ folder on the tree. To add a Dashboard for a *particular user only*, select the '`User Portal Dashboard Tab`' folder, and choose the desired user.
...
+
image::Edit Dashboard Admin VS.png[alt="select dashboard from list to pin as portal dashboard"]
