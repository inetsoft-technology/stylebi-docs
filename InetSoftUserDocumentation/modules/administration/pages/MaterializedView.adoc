...
// metadata for AI
ifdef::ai[]
Summary: How to configure and manage materialized views in Enterprise Manager, which pre-aggregate Dashboard data in a cache to dramatically improve query performance for end users.
endif::ai[]
