...
// metadata for AI
ifdef::ai[]
Summary: How to configure a database as the authentication provider in Enterprise Manager, including connection settings and user/role query configuration. Enterprise only.
endif::ai[]
