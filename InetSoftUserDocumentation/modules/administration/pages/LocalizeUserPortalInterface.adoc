...
// metadata for AI
ifdef::ai[]
Summary: How to localize User Portal and Enterprise Manager interface text (tabs, nodes, labels) by creating srinter_{language}_{country}.properties translation files.
endif::ai[]
...
image::Portal Localization Viewer.png[alt="localized user portal landing page in French"]

.Localized Repository Tree
image::Portal Localization Viewer2.png[alt="localized repository tree in French"]

.Localized Dialog Box
image::Portal Localization Viewer3.png[alt="localized dialog box in French"]
