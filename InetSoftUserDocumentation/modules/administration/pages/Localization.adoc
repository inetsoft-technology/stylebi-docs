...
// metadata for AI
ifdef::ai[]
Summary: Overview and navigation page for localization features, linking to instructions for localizing the User Portal interface, Dashboards, and data source names.
endif::ai[]
