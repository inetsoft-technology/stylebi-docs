...
// metadata for AI
ifdef::ai[]
Summary: How to configure server properties and storage using the Groovy DSL Administration Console :setup command when the server is not running. Enterprise only.
endif::ai[]
