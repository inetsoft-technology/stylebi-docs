...
* xref:viewsheetscript:ChartHighlighted.adoc[Chart.highlighted], xref:viewsheetscript:TableHighlighted.adoc[Table.highlighted], xref:viewsheetscript:ImageHighlighted.adoc[Image.highlighted], xref:viewsheetscript:TextHighlighted.adoc[Text.highlighted] to determine in Dashboard script whether a highlight has been applied or not.
====
