...
// metadata for AI
ifdef::ai[]
Summary: How to create scheduled tasks, cycles, and alerts in Enterprise Manager, including defining conditions, actions, and delivery options for automated Dashboard generation.
endif::ai[]
