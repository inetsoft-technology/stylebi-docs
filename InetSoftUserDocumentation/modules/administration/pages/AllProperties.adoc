...
// metadata for AI
ifdef::ai[]
Summary: Reference for all server configuration properties that can be set manually via the properties file. Covers all supported data sources and configuration knobs. Includes instructions for setting property file paths.
endif::ai[]
