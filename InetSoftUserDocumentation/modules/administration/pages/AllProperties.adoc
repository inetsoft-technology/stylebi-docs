...
em.home.link:: Sets the URL of the ‘Home’ button in Enterprise Manager. (The default is the `index.html` landing page). This can be an absolute URL such as https://www.google.com, or a path relative to `/app/` such as  `composer`. See  xref:Presentation.adoc#PortalIntegration[Portal Integration] for more information.
