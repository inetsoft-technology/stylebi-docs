...
share.slack.enabled:: Enables the {buttonSlack} under the {buttonSocialSharing}  in the Dashboard toolbar.  Default is `false`. Requires `share.slack.url` to also be set, otherwise the option remains hidden.
...
share.googlechat.enabled:: Enables the {buttonGoogleHangoutsChat} under the {buttonSocialSharing}  in the Dashboard toolbar.  Default is `false`. Requires `share.googlechat.url` to also be set, otherwise the option remains hidden.
