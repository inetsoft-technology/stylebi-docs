...
// metadata for AI
ifdef::ai[]
Summary: Reference for scheduler task conditions that determine when a scheduled task executes, including time-based, completion-based, and chained conditions. See CreateScheduledTask.
endif::ai[]
