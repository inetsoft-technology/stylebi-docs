...
// metadata for AI
ifdef::ai[]
Summary: How to configure the visual appearance and branding of the User Portal in Enterprise Manager, including logos, color themes, and multi-tenant presentation options.
endif::ai[]
