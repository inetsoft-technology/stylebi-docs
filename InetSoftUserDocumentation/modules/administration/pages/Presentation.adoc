...
. *_Optional:_* Select '`Drill Tabs Top`' to display tabs of drill-down Dashboards at the top of the screen.  (See xref:viewsheet:DrillDownIntoData.adoc#DrillwithChartHyperlinks[Drill with Chart Hyperlinks] for more details on drill-down features.)
