...
// metadata for AI
ifdef::ai[]
Summary: How to open Enterprise Manager in a web browser and log in to access the server administration interface.
endif::ai[]
...
+
image::InetSoft Home Screen.png[alt="StyleBI webapp homepage with Enterprise Manager link"]
+
...
+
image::Enterprise Manager Login Screen.png[alt="Enterprise Manager login screen"]
+
