...
// metadata for AI
ifdef::ai[]
Summary: How to create a custom geographic map in Enterprise Manager for use in Dashboard map charts, including uploading shape files and configuring region mappings.
endif::ai[]
