...
// metadata for AI
ifdef::ai[]
Summary: How to manage repository contents using the Groovy DSL Administration Console :files command for importing, exporting, and backing up repository assets. Enterprise only.
endif::ai[]
