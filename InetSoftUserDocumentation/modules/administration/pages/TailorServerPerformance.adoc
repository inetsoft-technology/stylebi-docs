...
// metadata for AI
ifdef::ai[]
Summary: How to configure server performance options in Enterprise Manager, including thread pools, query timeouts, and other performance tuning parameters.
endif::ai[]
