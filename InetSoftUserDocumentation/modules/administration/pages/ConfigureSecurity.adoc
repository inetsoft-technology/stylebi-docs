...
// metadata for AI
ifdef::ai[]
Summary: Step-by-step overview for setting up security on the InetSoft server, including specifying authentication/authorization providers, creating users, groups, and roles, and setting repository and action permissions.
endif::ai[]
