...
// metadata for AI
ifdef::ai[]
Summary: How to navigate the Enterprise Manager interface after logging in, including using the Settings button and left-side navigation tree to access administrative panels, searching for settings, and bookmarking frequently used pages as favorites.
endif::ai[]
...
image::Figure 1.png[alt="settings button at top of enterprise manager"]
...
image::EM_Search.png[alt="search bar in enterprise manager navigation tree"]
...
image::Bookmark1.png[alt="add bookmark button in enterprise manager toolbar"]
...
image::Bookmark2.png[alt="select saved bookmark from favorites menu"]
...
image::Bookmark3.png[alt="manage favorites menu to delete bookmarks"]
