...
// metadata for AI
ifdef::ai[]
Summary: Repository permissions in StyleBI control which items (folders, dashboards, worksheets, and other assets) are visible and accessible to specific users, roles, or groups. These permissions operate independently of data security, ensuring users only see and interact with authorized repository content.
endif::ai[]
