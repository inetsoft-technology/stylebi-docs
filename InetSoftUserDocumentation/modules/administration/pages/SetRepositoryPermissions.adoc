...
// metadata for AI
ifdef::ai[]
Summary: How to set, copy, and paste repository permissions in Enterprise Manager for Dashboards, folders, data sources, and other repository assets. Covers assigning READ, WRITE, DELETE, SHARE, and ADMIN permissions to users, roles, or groups, and explains the derive-from-parent inheritance model.
endif::ai[]
