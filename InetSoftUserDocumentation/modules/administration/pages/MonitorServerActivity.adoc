...
// metadata for AI
ifdef::ai[]
Summary: How to use the Monitoring section of Enterprise Manager to track server activity, including executing Dashboards, running queries, cache usage, active user sessions, cluster nodes, and server logs. Covers how to terminate Dashboards, queries, or user sessions from the monitoring pages.
endif::ai[]
