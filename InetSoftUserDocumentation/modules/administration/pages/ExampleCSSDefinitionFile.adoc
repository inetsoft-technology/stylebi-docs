...
// metadata for AI
ifdef::ai[]
Summary: Annotated example CSS definition file demonstrating global, type, class, and ID selectors for styling Dashboard components. See CreateCSSDefinitionFile for creation steps.
endif::ai[]
...
For an example of applying these CSS definitions to a Dashboard see xref:dashboard:VisualFormat.adoc[]  in xref:dashboard:VisualizeYourData.adoc[].
...
image::CSSExp_global.png[alt="global CSS font applied to dashboard components"]
...
----
image::CSSExp_Chart.png[alt="CSS chart background color applied to dashboard"]
...
----
image::CSSExp_tableTitle.png[alt="CSS green color applied to table title bar"]
...
----
image::CSSExp_ChartAxisTitle.png[alt="CSS yellow background on chart axis titles"]
...
----
image::CSSExp_ChartAxisTitleX.png[alt="CSS dark khaki background on chart X-axis title"]
...
image::CSSExp_Header2.png[alt="Header2 CSS class styling applied to component"]
...
----
image::CSSExp_ChartAxisText.png[alt="AxisText CSS class bold font on chart axis"]
...
----
image::CSSExp_TableClass.png[alt="CSS ID SalesTable background color applied"]
...
----
image::CSSExp_TableStyleClass.png[alt="YellowRows class styling odd rows yellow"]

See xref:CreateCSSDefinitionFile.adoc#CSSTableStyle[CSS TableStyle] for information about TableStyles.

For information on setting a Dashboard component’s CSS Class and ID, see xref:dashboard:VisualFormat.adoc[] in xref:dashboard:VisualizeYourData.adoc[].