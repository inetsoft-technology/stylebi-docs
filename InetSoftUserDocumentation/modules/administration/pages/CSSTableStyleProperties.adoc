...
// metadata for AI
ifdef::ai[]
Summary: Reference table of table region CSS selectors (e.g., Header, Body, EvenRow) available for formatting Table, Crosstab, and Freehand Table components via CSS TableStyle syntax.
endif::ai[]
