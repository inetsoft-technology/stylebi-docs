...
// metadata for AI
ifdef::ai[]
Summary: How to integrate a D3.js chart into a Dashboard using the InetSoft D3 plugin in Enterprise Manager, covering the two-step process of creating the D3 script and adding it to a Dashboard component.
endif::ai[]
