...
// metadata for AI
ifdef::ai[]
Summary: How to monitor and manage scheduled cycles using the Groovy DSL Administration Console :schedule command, including adding, editing, and checking cycle status. Enterprise only.
endif::ai[]
