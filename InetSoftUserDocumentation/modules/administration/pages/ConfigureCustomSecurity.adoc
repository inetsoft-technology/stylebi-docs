...
// metadata for AI
ifdef::ai[]
Summary: How to configure a custom Java authentication class as the security provider in Enterprise Manager for cases where built-in providers are insufficient. Enterprise only.
endif::ai[]
