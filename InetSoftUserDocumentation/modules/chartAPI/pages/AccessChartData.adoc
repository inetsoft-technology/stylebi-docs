...
[source,javascript]
----
include::scriptexample:partial$AccessChartDataExp.js[]
----
...
+
image::commonscript:ChartTableArrayExample.png[alt="bar chart with threshold-based value labels"]
====
