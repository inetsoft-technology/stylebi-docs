...
[source,javascript]
----
include::scriptexample:partial$LegendSpecSetTitleVisible1.js[]
----
<1> {dataset}
...
image::commonscript:LegendSpecsetTitleVisible.png[alt="legend with title hidden"]
