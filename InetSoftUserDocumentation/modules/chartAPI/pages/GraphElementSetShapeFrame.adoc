...
[source,javascript]
----
include::scriptexample:partial$GraphElementSetShapeFrame1.js[]
----
<1> {dataset}
...
image::commonscript:GraphElementsetShapeFrame.png[alt="point chart with StarShapeFrame applied"]
