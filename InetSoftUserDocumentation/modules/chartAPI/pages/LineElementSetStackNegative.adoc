...
[source,javascript]
----
include::scriptexample:partial$LineElementSetStackNegative1.js[]
----
...
image::commonscript:LineElementsetStackNegative.png[alt="line chart with arithmetically stacked negative values"]
