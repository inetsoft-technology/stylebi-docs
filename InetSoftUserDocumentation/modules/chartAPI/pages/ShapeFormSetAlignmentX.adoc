...
[source,javascript]
----
include::scriptexample:partial$ShapeFormSetAlignmentX1.js[]
----
<1> {dataset}
...
image::commonscript:ShapeformSetAlignmentX.png[alt="bar chart with two triangles showing left and center horizontal alignment"]
