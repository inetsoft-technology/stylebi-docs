...
image::commonscript:MultipleMeasuresExample.png[alt="bar chart displaying State and Quantity 1 as single measure"]
...
+
image::commonscript:MultipleMeasuresExample2.png[alt="chart with bars for Quantity 1 and line for Quantity 2 with auto-generated legend"]
