...
[source,javascript]
----
include::scriptexample:partial$SVGShape1.js[]
----
<1> {dataset}
...
image::commonscript:StaticShapeFrameSVG_1.png[alt="point chart using SVGShape.FACE_HAPPY constant as element shape"]
...
[source,javascript]
----
include::scriptexample:partial$SVGShape2.js[]
----
<1> {dataset}
...
[source,javascript]
----
include::scriptexample:partial$SVGShape3.js[]
----
<1> {dataset}
...
image::commonscript:StaticShapeFrameSVG_3.png[alt="point chart using SVGShape loaded from remote URL as element shape"]
