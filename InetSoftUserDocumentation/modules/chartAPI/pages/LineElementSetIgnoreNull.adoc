...
// metadata for AI
ifdef::ai[]
Summary: Chart Script API reference for `LineElement.setIgnoreNull(Boolean)`. This is part of StyleBI's Chart Script (Chart API) scripting layer — a last-resort approach for chart customization/interactivity. See chartAPI:ChartScriptTutorial.adoc for guidance on when to use scripting vs. UI-driven alternatives (built-in toolbar tools, Ad Hoc Editor, Form-driven dynamic properties).
endif::ai[]
...
[source,javascript]
----
include::scriptexample:partial$LineElementSetIgnoreNull1.js[]
----
...
image::commonscript:setIgnoreNull1.png[alt="line chart with gap at null value"]


.Chart Component Script: Continue Line at Null
[source,javascript]
----
include::scriptexample:partial$LineElementSetIgnoreNull2.js[]
----
...
image::commonscript:setIgnoreNull2.png[alt="line chart continuing through null value"]
