...
// metadata for AI
ifdef::ai[]
Summary: How to create a new data block by dragging and dropping tables and fields in the Data Worksheet to combine or blend data from multiple data sources (mashup, blend data), suitable for simple column selection from data models or database tables.
endif::ai[]
