...
To upload a text or Excel data into a new Embedded Table, see xref:UploadData.adoc[].
//endif::[]

////
ifdef::testdrive[]
To upload a text or Excel data into a new Embedded Table, see Upload an Excel or Text File. XXXX
endif::[]
////

To upload a text or Excel data into an existing Embedded Table, follow the steps below.
...
////
ifdef::testdrive[]
. Open the Dashboard for editing. (See XXXXXX.)
endif::[]
////
