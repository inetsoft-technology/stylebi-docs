...
// metadata for AI
ifdef::ai[]
Summary: How to create a concatenated data block in a Data Worksheet by combining two or more data blocks vertically using union, intersection, or difference (minus) operations.
endif::ai[]
