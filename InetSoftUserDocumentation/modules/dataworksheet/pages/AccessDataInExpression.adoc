...
// metadata for AI
ifdef::ai[]
Summary: How to access data block column values within Data Worksheet expressions in Visual Composer, including current-row field access, row indexing, and referencing other data blocks. See CreateNewDataField for how to add expression columns.
endif::ai[]
:experimental:
