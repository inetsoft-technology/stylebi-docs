...
// metadata for AI
ifdef::ai[]
Summary: How to create a Data Worksheet query from a Facebook Page Insights connection in Visual Composer (Enterprise only) by selecting a Metric Type, Date Preset, Metrics, and Additional Parameters in the Facebook Page Insights Query dialog. Covers querying page engagement and performance metrics using the Facebook Marketing API.
endif::ai[]
...
+
image::FacebookPageInsightsQuery1.png[alt="select Facebook Page Insights Query button from the toolbar"]
+
This opens the ‘Facebook Page Insights  Query’ dialog box.
+
image::FacebookPageInsightsQuery2.png[alt="Facebook Page Insights Query dialog box for configuring the data query"]
