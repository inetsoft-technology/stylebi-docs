...
// metadata for AI
ifdef::ai[]
Summary: Filter data in a worksheet using dynamic conditions that apply user-selected values, variables, or expressions at runtime, allowing rows to be included or excluded based on changing criteria without requiring script.
endif::ai[]
