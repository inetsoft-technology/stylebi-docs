...
// metadata for AI
ifdef::ai[]
Summary: How to filter data in a Data Worksheet data block, including pre-aggregate and post-aggregate conditions, ranking (top-N/bottom-N) filters, dynamic conditions using variables, session data, field comparisons, expressions, and subqueries, plus materialized view update conditions.
endif::ai[]
