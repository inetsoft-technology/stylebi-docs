...
// metadata for AI
ifdef::ai[]
Summary: How to create a Data Worksheet query in Visual Composer from a MongoDB REST connection by entering a query using MongoDB JSON command format with an aggregation command. Links to MongoDB documentation for JSON syntax and aggregation command references.
endif::ai[]
