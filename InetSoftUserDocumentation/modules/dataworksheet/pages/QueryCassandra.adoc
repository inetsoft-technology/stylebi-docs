...
// metadata for AI
ifdef::ai[]
Summary: How to create a Data Worksheet query from a Cassandra connection by entering a Cassandra SQL string in the 'SQL' field, with an optional tabular data format selection. Covers opening the Cassandra Query dialog box and completing the query setup in a Data Worksheet.
endif::ai[]
