...
// metadata for AI
ifdef::ai[]
Summary: How to import or upload data (import CSV, upload file) from a text file, CSV, or Excel file directly into a Data Worksheet as an Embedded Table, without creating a persistent data source connection.
endif::ai[]
