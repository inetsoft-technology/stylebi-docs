...
// metadata for AI
ifdef::ai[]
Summary: How to sort data in a Data Worksheet on one or more columns. Covers sort direction and the difference between Data Worksheet-level sorting vs. Dashboard-level sorting.
endif::ai[]
