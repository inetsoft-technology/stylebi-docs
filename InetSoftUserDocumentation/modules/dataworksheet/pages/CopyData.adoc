...
// metadata for AI
ifdef::ai[]
Summary: How to copy a data block in a Data Worksheet using a regular copy (independent duplicate) or a mirror copy (linked duplicate that reflects changes to the original).
endif::ai[]
