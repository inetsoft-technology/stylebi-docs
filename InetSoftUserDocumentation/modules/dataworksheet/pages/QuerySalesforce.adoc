...
// metadata for AI
ifdef::ai[]
Summary: How to create a Data Worksheet query from a Salesforce data source, including optionally enabling the Bulk API for large data sets, selecting an SObject table, and entering a SOQL query. This is an Enterprise-only feature.
endif::ai[]
