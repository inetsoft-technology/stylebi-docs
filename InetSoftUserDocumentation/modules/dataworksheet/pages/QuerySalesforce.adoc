...
// metadata for AI
ifdef::ai[]
Summary: How to create a Data Worksheet query in Visual Composer from a Salesforce data source, including optionally enabling the Bulk API for large data sets, selecting an SObject table, and entering a SOQL query. This is an Enterprise-only feature.
endif::ai[]
...
+
image::dataSourceSalesforce5.png[alt="select Salesforce Query button from the toolbar"]
+
...
+
image::dataSourceSalesforce6.png[alt="SOQL query entered in the text box"]
+
