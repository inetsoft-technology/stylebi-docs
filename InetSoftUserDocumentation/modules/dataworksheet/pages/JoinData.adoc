...
// metadata for AI
ifdef::ai[]
Summary: How to join two or more data blocks horizontally in a Data Worksheet, defining equality or inequality join conditions to combine data from different tables, queries, or data models.
endif::ai[]
