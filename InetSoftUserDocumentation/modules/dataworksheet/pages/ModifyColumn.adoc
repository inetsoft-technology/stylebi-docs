...
// metadata for AI
ifdef::ai[]
Summary: How to modify columns in a Data Worksheet data block, including searching for columns, renaming, repositioning, hiding, changing data types (for Embedded Tables), and adding column descriptions.
endif::ai[]
...
image::searchColumn.png[alt="press Search Columns button and type column name to find a column"]
...
+
image::embeddedTableColumnType2.png[alt="right-click column header and select Column Type from context menu"]
+
This opens the ‘Column Type’ panel.

. Select the desired data type from the ‘Type’ menu. The available data types are shown below:
+
include::ROOT:partial$DataTypeTable.adoc[]
+
If you select a numeric or date type, a secondary ‘Parse Format’ menu appears below.
...
+
image::embeddedTableColumnType.png[alt="right-click header cell and select Column Type to open the Column Type panel"]
. Select ‘Integer’ from the ‘Type’ menu and press btn:[OK].
+
image::selectIntegerColumnType.png[alt="select Integer from the Type menu in the Column Type panel"]
****
...
+
image::AddColumnDescription.png[alt="right-click column header and select Column Description from context menu"]
+
. Add or edit the desired description in the ‘Column Description’ dialog box and press ‘OK’.
+
image::AddColumnDescription2.png[alt="Column Description dialog box to add or edit the column description text"]
...
image::reorderColumns.png[alt="Reorder Columns dialog with Up Down Move to Top and Bottom buttons"]
...
image::showHideColumns.png[alt="Show Hide Columns dialog to select which columns to hide"]
