...
// metadata for AI
ifdef::ai[]
Summary: How to modify columns in a Data Worksheet data block in Visual Composer, including renaming, reordering, hiding, changing data types, and setting column aliases.
endif::ai[]
