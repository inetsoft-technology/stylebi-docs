...
// metadata for AI
ifdef::ai[]
Summary: How to create a Data Worksheet query from a Google Analytics GA4 connection in Visual Composer (Enterprise only) by entering dimensions and metrics query parameters in the Google Analytics GA4 Query dialog. Covers configuring GA4 API query parameters using the Dimensions and Metrics Explorer for version 4.0.
endif::ai[]
