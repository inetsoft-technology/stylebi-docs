...
Dashboard Level::
To group and aggregate data at the Dashboard level, see the following sections in xref:viewsheet:VisualizeYourData.adoc[]. This provides the user with the greatest flexibility to adjust the grouping and aggregation to suit their needs.
[square]
* To group and aggregate data in  Chart, see xref:viewsheet:GroupDataByDimension.adoc[].
* To group and aggregate data in a  crosstab, see xref:viewsheet:AddCrosstab.adoc[].
