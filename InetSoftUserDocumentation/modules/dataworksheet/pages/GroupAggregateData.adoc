...
// metadata for AI
ifdef::ai[]
Summary: How to group and aggregate (summarize) data in a Data Worksheet, equivalent to a SQL GROUP BY or aggregate query, including choosing group-by columns, aggregate functions, named groups (custom grouping), and deciding between Data Worksheet vs. Dashboard-level aggregation.
endif::ai[]
