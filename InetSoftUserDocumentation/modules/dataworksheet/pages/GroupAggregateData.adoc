...
// metadata for AI
ifdef::ai[]
Summary: How to group and aggregate (summarize) data in a Data Worksheet, including choosing group-by columns, aggregate functions, and deciding between Data Worksheet vs. Dashboard-level aggregation.
endif::ai[]
