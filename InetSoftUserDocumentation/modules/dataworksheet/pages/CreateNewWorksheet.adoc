...
// metadata for AI
ifdef::ai[]
Summary: How to create a new Data Worksheet (query builder, data pipeline, data prep) from the User Portal or from within Visual Composer (the dashboard designer), including the New Data Worksheet dialog options (Mashup, Query, Upload) and how to save a worksheet with the correct scope (public or private).
endif::ai[]
...
image::user:PortalCreateWorksheet2.png[alt="select Data Worksheet in left panel and press New Worksheet button"]
...
image::user:CreateNewAsset.png[alt="press Create button in Visual Composer and select New Worksheet"]

== Create a New Folder
To create a new asset folder in Visual Composer, see xref:dashboard:CreateNewDashboard.adoc#CreateNewAssetFolder[Create a New Folder].
