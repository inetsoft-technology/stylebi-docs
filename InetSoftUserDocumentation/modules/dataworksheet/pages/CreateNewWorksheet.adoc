...
// metadata for AI
ifdef::ai[]
Summary: How to create a new Data Worksheet from the User Portal or from within Visual Composer, including the New Data Worksheet dialog options (Mashup, Query, Upload) and how to save a worksheet with the correct scope (public or private).
endif::ai[]
