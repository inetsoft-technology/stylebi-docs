...
// metadata for AI
ifdef::ai[]
Summary: How to create a new Data Worksheet in Visual Composer by querying a data source, including selecting data blocks, configuring fields, and saving the worksheet.
endif::ai[]
