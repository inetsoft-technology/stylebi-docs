...
// metadata for AI
ifdef::ai[]
Summary: How to define a Variable in a Data Worksheet and use it in filter conditions to create parameterized queries where the user supplies the value at runtime. Variables defined here are automatically available as parameters in any Dashboard that uses the worksheet — accessible via the parameter.variableName syntax in Dashboard script, or controllable via Dashboard Form components.
endif::ai[]
