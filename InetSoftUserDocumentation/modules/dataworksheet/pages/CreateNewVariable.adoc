...
// metadata for AI
ifdef::ai[]
Summary: How to define a Variable in a Data Worksheet in Visual Composer and use it in filter conditions to create parameterized queries where the user supplies the value at runtime.
endif::ai[]
