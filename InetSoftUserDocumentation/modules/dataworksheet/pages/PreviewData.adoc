...
// metadata for AI
ifdef::ai[]
Summary: How to preview the data returned by a Data Worksheet data block using Live Data View, showing a limited sample along with query execution time, and how to enable or disable the display row limit.
endif::ai[]
