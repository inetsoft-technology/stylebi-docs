...
// metadata for AI
ifdef::ai[]
Summary: How to preview the data returned by a Data Worksheet data block in Visual Composer using Live Data View, showing a limited sample along with query execution time.
endif::ai[]
