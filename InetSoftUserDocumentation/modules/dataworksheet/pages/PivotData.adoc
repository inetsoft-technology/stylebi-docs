...
// metadata for AI
ifdef::ai[]
Summary: How to pivot, unpivot, reshape, or transpose data in a Data Worksheet, converting multiple measures into a single measure with a new dimension, or expanding dimension values into separate measure columns.
endif::ai[]
