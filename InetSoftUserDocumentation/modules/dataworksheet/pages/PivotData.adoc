...
// metadata for AI
ifdef::ai[]
Summary: How to pivot or unpivot data in a Data Worksheet, converting multiple measures into a single measure with a new dimension (using the Unpivot option), or expanding a single measure into multiple measures by converting a data block into a Crosstab.
endif::ai[]
...
image::pivotMeasure1.png[alt="data block with one Name dimension and three year salary measures"]
...
+
image::pivotMeasure2.png[alt="right-click data block and select Unpivot from context menu"]
...
+
image::pivotMeasure3.png[alt="enter number of row header levels in the Unpivot Data dialog"]
...
+
image::pivotMeasure4.png[alt="unpivoted data block showing measure labels as dimension values and single Measure column"]
...
image::pivotMeasure5.png[alt="data block with Name and Year dimensions and single Salary measure"]
...
+
image::pivotMeasure6.png[alt="press Group and Aggregate button in the bottom panel toolbar"]

. In the ‘Group and Aggregate’ panel, press btn:[Switch to Crosstab].
+
image::pivotMeasure7.png[alt="press Switch to Crosstab button in the Group and Aggregate panel"]
...
+
image::pivotMeasure8.png[alt="crosstab panel with Name row header Year column header and Salary measure configured"]
...
+
image::pivotMeasure9.png[alt="crosstab data block showing Year dimension values as separate measure columns"]
