...
// metadata for AI
ifdef::ai[]
Summary: How to create new calculated data fields in Visual Composer, including expression columns (JavaScript or SQL) in a Data Worksheet data block, and Dashboard calculated fields for detail-level or aggregate-level calculations. Covers formula syntax, data types, and referencing existing columns.
endif::ai[]
:experimental:
