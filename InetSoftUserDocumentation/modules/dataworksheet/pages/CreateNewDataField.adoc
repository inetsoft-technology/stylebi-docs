...
image::viewsheet:NewCalculatedField1.png[alt="right-click data block in Toolbox and select New Calculated Field"]
...
+
image::viewsheet:NewCalculatedField2.png[alt="select Detail or Aggregate option in Calculated Field panel"]
...
image::viewsheet:NewCalculatedField4.png[alt="new calculated field added to data source in Toolbox panel"]
...
image::viewsheet:NewCalculatedField3.png[alt="Edit Calculated Field dialog showing detail fields available for expression"]
...
+
image::viewsheet:CalcFieldExample8.png[alt="press New Aggregate link to add a new aggregate to the list"]
+
...
+
image::viewsheet:CalcFieldExample9.png[alt="select field to aggregate in the Aggregate dialog box"]
+
...
+
image::viewsheet:CalcFieldExample10.png[alt="newly defined aggregate appears in the top-left panel of Formula Editor"]
+
...
+
image::viewsheet:CalcFieldExample11.png[alt="enter calculation using aggregate fields in the formula area"]
...
image::viewsheet:galleryBubble2.png[alt="Global Visual Analysis dashboard sample using calculated fields for map colors"]
****
