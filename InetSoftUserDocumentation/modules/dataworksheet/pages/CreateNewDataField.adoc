...
// metadata for AI
ifdef::ai[]
Summary: How to add a new calculated field to a Data Worksheet data block using an expression column or a named grouping column. Covers formula syntax and referencing existing columns.
endif::ai[]
:experimental:
