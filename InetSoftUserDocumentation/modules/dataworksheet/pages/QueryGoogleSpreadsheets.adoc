...
// metadata for AI
ifdef::ai[]
Summary: How to create a Data Worksheet query from an existing Google Spreadsheets Query connection, including browsing available fields and configuring query parameters. See QuerySpecificDataSource for the full list of available data source query types.
endif::ai[]
