...
// metadata for AI
ifdef::ai[]
Summary: How to create a Data Worksheet query from a Google Spreadsheets connection by selecting a Spreadsheet and Worksheet in the Google Spreadsheets Query dialog box. Note that the Google API reformats column names (lowercased, spaces removed). Requires a configured Google Spreadsheets data source connection.
endif::ai[]
...
+
image::dataSourceGoogleSheets5.png[alt="Google Spreadsheets Query dialog box for configuring the data query"]
...
+
image::dataSourceGoogleSheets6.png[alt="Spreadsheet and Worksheet menus with desired options chosen"]
