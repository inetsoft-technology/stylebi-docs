...
image:dataworksheet:expandArrays1.png[alt="top level array expanded with Expand Arrays and Top Level Only enabled"]

If ‘Top Level Only’ is *disabled*, all arrays will be fully expanded in parallel, as shown below:

image:dataworksheet:expandArrays2.png[alt="all arrays fully expanded in parallel with Top Level Only disabled"]
...
image:dataworksheet:expandArrays3.png[alt="Expanded Array Path field set to selectively expand specific arrays"]
