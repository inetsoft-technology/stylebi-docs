...
+
image::dashboard:freehandExp22.png[alt="Dashboard Options Script tab with Sales Explore runQuery entered in onInit"]
+
...
+
image::dashboard:freehandExp34.png[alt="freehand table editor with Formula selected for rowList expression cell"]
...
+
image::dashboard:freehandExp31.png[alt="freehand table with Expand Cell Vertical set for rowList date column"]
...
+
image::dashboard:freehandExp32.png[alt="freehand table editor with field category formula for second column"]

. {finishEditing} The resulting table displays the date for all orders greater than $10,000, and the corresponding category.
+
image::dashboard:freehandExp33.png[alt="freehand table showing dates and categories for orders greater than ten thousand"]
====
