...
// metadata for AI
ifdef::ai[]
Summary: Draws a set of horizontal or vertical confidence intervals on the chart. See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
endif::ai[]


Draws a set of horizontal or vertical confidence intervals on the chart. See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
...
image::commonscript:PlotAddTargetCI.png[alt="chart with confidence interval target band displayed in red"]
