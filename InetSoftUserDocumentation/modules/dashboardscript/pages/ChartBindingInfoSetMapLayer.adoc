...
// metadata for AI
ifdef::ai[]
Summary: Specifies the map layer corresponding to a geographic field.
endif::ai[]
...
====
[square]
* xref:dashboardscript:ChartBindingInfoGetMapLayer.adoc[]  to return the layer assigned to a geographic field.
* xref:dashboardscript:PlotMapType.adoc[] to set the outline of the map.
====
...
image::commonscript:bindingInfoGeoFields_1.png[alt="map chart with state field assigned to the State geographic layer"]
