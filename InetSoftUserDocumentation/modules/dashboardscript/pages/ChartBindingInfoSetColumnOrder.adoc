...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboardscript:ChartBindingInfoGetColumnOrder.adoc[] to obtain existing binding information.
endif::ai[]


[WARNING,caption=See Also]
xref:dashboardscript:ChartBindingInfoGetColumnOrder.adoc[]  to obtain existing binding information.
...
image::commonscript:SetColumnOrder.png[alt="chart with Company dimension sorted in descending alphabetical order"]
...
image::commonscript:SetColumnOrder1.png[alt="chart with Company dimension sorted descending by Sum of Total value"]
