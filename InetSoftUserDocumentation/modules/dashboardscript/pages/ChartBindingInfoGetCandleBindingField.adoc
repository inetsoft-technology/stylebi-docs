...
// metadata for AI
ifdef::ai[]
Summary: xref:ChartBindingInfoSetCandleBindingField.adoc[] to set the binding information.
endif::ai[]
...
Returns the field used as the specified measure on a xref:dashboard:CandleChart.adoc[], together with associated binding information.
