...
:navtitle: setPresenter()
%experimental%
include::ROOT:partial$buttonSnippets.adoc[]

// metadata for AI
ifdef::ai[]
Summary: Sets the contents of a Table cell to the specified Presenter. Built-in presenters include the following:
endif::ai[]



Sets the contents of a Table cell to the specified Presenter. Built-in presenters include the following:
...
TableView1.setPresenter      // qualified
