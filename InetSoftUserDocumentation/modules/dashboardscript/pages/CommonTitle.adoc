...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboard:GeneralTab.adoc[] for more information about setting the title.
endif::ai[]

[WARNING,  caption=See Also]
xref:dashboard:GeneralTab.adoc[] for more information about setting the title.
