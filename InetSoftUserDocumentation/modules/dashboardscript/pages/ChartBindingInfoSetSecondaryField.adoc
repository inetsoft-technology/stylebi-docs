...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboardscript:ChartBindingInfoGetSecondaryField.adoc[] to obtain the binding information.
endif::ai[]


[WARNING,caption=See Also]
xref:dashboardscript:ChartBindingInfoGetSecondaryField.adoc[]  to obtain the binding information.
