...
// metadata for AI
ifdef::ai[]
Summary: xref:ChartBindingInfoSetStockBindingField.adoc[] to set the binding information.
endif::ai[]
...
Return the field used as the specified measure on a xref:dashboard:StockChart.adoc[] (OHLC) chart, together with associated binding information.
