...
// metadata for AI
ifdef::ai[]
Summary: Specifies a mapping between axis values and replacement text.
endif::ai[]
...
image::commonscript:DefaultTextFrame.png[alt="chart with Company name text labels applied using DefaultTextFrame"]
