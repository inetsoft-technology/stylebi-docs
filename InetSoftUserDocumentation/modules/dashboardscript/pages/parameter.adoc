...
// metadata for AI
ifdef::ai[]
Summary: Script reference for the parameter property, which reads and writes Dashboard and session parameters including Data Worksheet variables, Form component values, hyperlink parameters, and session context like user and roles.
endif::ai[]
