...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboardscript:ChartBindingInfoGetGroupOrder.adoc[] to set the binding information.
endif::ai[]


[WARNING,caption=See Also]
xref:dashboardscript:ChartBindingInfoGetGroupOrder.adoc[]  to set the binding information.
...
--
image::commonscript:setGroupOrder.png[alt="chart with Order Date dimension grouped by quarter interval"]
