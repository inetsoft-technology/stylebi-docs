...
// metadata for AI
ifdef::ai[]
Summary: Identifies whether a highlight with the specified name has been applied to the Table (i.e., whether the highlight condition has been satisfied.) You can use this to alert the user that a highlight has been triggered.
endif::ai[]
