...
// metadata for AI
ifdef::ai[]
Summary: Sets the format for data values displayed within a shape-key legend (on charts that have *multiple* shape legends).
endif::ai[]
...
image::commonscript:shapeLegendsFormat.png[alt="chart shape legends with custom format applied to all legend labels"]
