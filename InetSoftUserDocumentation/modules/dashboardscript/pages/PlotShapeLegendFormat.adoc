...
// metadata for AI
ifdef::ai[]
Summary: Sets the format for data values displayed in the shape legend.
endif::ai[]
...
image::commonscript:shapeLegendFormatNumber.png[alt="chart shape legend with numeric format applied to legend values"]
...
image::commonscript:shapeLegendFormatText.png[alt="chart shape legend with text format applied to legend labels"]
