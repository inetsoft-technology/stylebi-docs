...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboard:VisualFormat.adoc[] for more information about setting borders.
endif::ai[]

[WARNING,  caption=See Also]
xref:dashboard:VisualFormat.adoc[] for more information about setting borders.
