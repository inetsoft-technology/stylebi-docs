...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboardscript:ChartBindingInfoSetSecondaryField.adoc[] to set the binding information.
endif::ai[]


[WARNING,caption=See Also]
xref:dashboardscript:ChartBindingInfoSetSecondaryField.adoc[]  to set the binding information.
