...
// metadata for AI
ifdef::ai[]
Summary: Draws a set of horizontal or vertical lines on the chart to mark the specified number of standard deviations from the mean. See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
endif::ai[]



Draws a set of horizontal or vertical lines on the chart to mark the specified number of standard deviations from the mean.  See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
...
image::commonscript:PlotAddTargetStDev1.png[alt="chart with standard deviation target lines at plus and minus 1 and 2"]
