...
// metadata for AI
ifdef::ai[]
Summary: Returns the value set by xref:CrosstabBindingInfoSetGroupOthers.adoc[] or by the '`Group all others together`' property in the Crosstab Editor.
endif::ai[]
...
image::commonscript:bindingInfoSetGroupOthers_1.png[alt="crosstab editor with Group all others together option visible"]
