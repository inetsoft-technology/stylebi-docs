...
// metadata for AI
ifdef::ai[]
Summary: Sets the format for data values displayed within a size-key legend on Charts that have *multiple* size legends.
endif::ai[]
...
image::commonscript:sizeLegendsFormat.png[alt="chart size legends with custom format applied to all legend labels"]
