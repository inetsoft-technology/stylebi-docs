...
// metadata for AI
ifdef::ai[]
Summary: Returns an array of the levels at which the user has made a selection. The array includes all levels from the top level to one level below the current selection. (The top level is included even when no selection is made.)
endif::ai[]
...
* xref:dashboard:SelectionTreeProperties.adoc[] for more information on Selection Trees.
====
...
image::dashboard:Selection Tree 3 Level_1.png[alt="three-level selection tree showing Region State City hierarchy for drillMembers example"]
...
+
image::commonscript:DrillMembersExample1.png[alt="selection tree with State and City fields added as two-level hierarchy"]
...
+
image::commonscript:DrillMembersExample3.png[alt="chart data source panel with State and City fields set as geographic"]
+
...
+
image::commonscript:DrillMembersExample5.png[alt="chart data panel with value type button showing Expression option selected"]

.. Press the {buttonEditFormula} to open the Script Editor.
+
image::commonscript:DrillMembersExample6.png[alt="script editor opened for editing the geographic dimension formula"]
...
+
image::commonscript:DrillMembersExample7.png[alt="script editor with SelectionTree1.drillMembers inserted as geographic binding expression"]
+
...
+
image::commonscript:DrillMembersExample8.png[alt="chart data panel showing drillMembers expression assigned to geographic binding"]
...
+
image::commonscript:DrillMembersExample10.png[alt="map chart showing total measure at state level with no selection tree selection"]
...
+
image::commonscript:DrillMembersExample9.png[alt="map chart filtered to California showing total measure at city level"]
