...
// metadata for AI
ifdef::ai[]
Summary: Specifies whether a trailing row containing totals should be displayed. This is equivalent to setting ‘Row Total’ in the Crosstab Editor.
endif::ai[]
...
image::commonscript:bindingInfoshowRowTotal.png[alt="crosstab editor with Row Total option enabled"]
...
image::commonscript:bindingInfoshowRowTotal2.png[alt="crosstab with trailing row displaying grand totals for all measures"]
