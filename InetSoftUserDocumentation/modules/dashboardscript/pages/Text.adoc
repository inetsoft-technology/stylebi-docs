...
// metadata for AI
ifdef::ai[]
Summary: Script reference index for the Text/KPI component, listing its unique scriptable properties. See CommonProperties for shared properties.
endif::ai[]
...
* xref:dashboard:AddAKPI.adoc[] for more information about how to display an aggregate as text.
* xref:dashboard:AddTextOrHTML.adoc[] for more information about how to display text on a Dashboard.
====
