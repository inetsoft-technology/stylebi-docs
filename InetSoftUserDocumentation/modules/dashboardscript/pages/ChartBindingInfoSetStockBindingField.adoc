...
// metadata for AI
ifdef::ai[]
Summary: xref:ChartBindingInfoGetStockBindingField.adoc[] to obtain the binding information.
endif::ai[]
...
Configure the binding for a xref:dashboard:StockChart.adoc[], also known as an open-hi-low-close (OHLC) chart. A stock chart displays four different measures, “low,” “high,” “opening,” and “closing,” and is most often used to plot trading information.
...
+
image::commonscript:setStockBinding2.png[alt="stock chart displaying average high low open close prices by quarter"]
+
...
+
image::commonscript:setStockBinding3.png[alt="stock chart filtered to year 2004 showing quarterly OHLC structure"]
