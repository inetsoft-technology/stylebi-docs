...
// metadata for AI
ifdef::ai[]
Summary: Returns the date grouping level specified by xref:CrosstabBindingInfoSetGroupOrder.adoc[] or set by the ‘Level’ option in the Crosstab Editor.
endif::ai[]
...
image::commonscript:bindingInfoSetGroupOrder_1.png[alt="crosstab editor showing date grouping level set for a row header"]
