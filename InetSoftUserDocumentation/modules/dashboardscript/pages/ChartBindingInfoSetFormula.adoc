...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboardscript:ChartBindingInfoGetFormula.adoc[] to obtain existing binding information.
endif::ai[]


[WARNING,caption=See Also]
xref:dashboardscript:ChartBindingInfoGetFormula.adoc[]  to obtain existing binding information.
...
----
image::commonscript:bindingInfoSetFormula_3.png[alt="chart with Total field on Y-axis aggregated using Max formula"]
...
----
image::commonscript:bindingInfoSetFormulaColor.png[alt="chart with Total field color-coded using Max formula on ColorFrame"]
