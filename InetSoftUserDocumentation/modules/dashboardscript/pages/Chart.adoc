...
// metadata for AI
ifdef::ai[]
Summary: Script reference index for the Chart component, listing all scriptable Chart properties. See CommonProperties for shared properties and ChartScriptTutorial for examples.
endif::ai[]
