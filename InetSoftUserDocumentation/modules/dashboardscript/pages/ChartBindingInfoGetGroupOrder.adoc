...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboardscript:ChartBindingInfoSetGroupOrder.adoc[] to set the binding information.
endif::ai[]


[WARNING,caption=See Also]
xref:dashboardscript:ChartBindingInfoSetGroupOrder.adoc[]  to set the binding information.
