...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboardscript:GaugeQuery.adoc[] to specify the data block from which to draw the fields.
endif::ai[]

[WARNING,caption=See Also]
xref:dashboardscript:GaugeQuery.adoc[] to specify the data block from which to draw the fields.
...
image::dashboardscript:GaugeFields.png[alt="gauge component Data tab showing Columns field binding selection"]
