...
// metadata for AI
ifdef::ai[]
Summary: Draws a set of horizontal or vertical target lines in the plot area using the specified colors and options. See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
endif::ai[]



Draws a set of horizontal or vertical target lines in the plot area using the specified colors and options.  See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
...
image::commonscript:PlotAddTarget.png[alt="chart with single target line at 2500000 with fill above and below"]
...
image::commonscript:PlotAddTarget2.png[alt="chart with multiple target lines at average and maximum with fill bands"]
