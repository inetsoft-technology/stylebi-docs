...
// metadata for AI
ifdef::ai[]
Summary: Returns the value set by xref:CrosstabBindingInfoSetTopNReverse.adoc[] or by the '`Rank`' property in the Crosstab Editor.
endif::ai[]
...
image::commonscript:bindingInfoSetTopNExp3_1.png[alt="crosstab editor showing Rank property controlling top or bottom group display"]
