...
// metadata for AI
ifdef::ai[]
Summary: Specifies the field to be used in the '`Path`' binding. See xref:dashboard:MapChart.adoc[] for more information about '`Path`'.
endif::ai[]
...
Specifies the  field to be  used in the '`Path`' binding.  See xref:dashboard:MapChart.adoc[] for more information about '`Path`'.
...
image::commonscript:bindingInfoPathField.png[alt="map chart with path drawn through points in ascending longitude order"]
