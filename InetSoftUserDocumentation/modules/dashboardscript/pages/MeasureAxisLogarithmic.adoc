= axis.logarithmic
:page-aliases: viewsheetscript:MeasureAxisLogarithmic.adoc
%experimental%
...
image:commonscript:measureLogarithmic.png[alt="chart with measure axis displayed on logarithmic scale"]
