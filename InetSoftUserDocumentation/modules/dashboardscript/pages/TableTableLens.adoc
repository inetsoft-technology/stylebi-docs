...
// metadata for AI
ifdef::ai[]
Summary: Specifies the Table’s TableLens object, which allows you to access and modify table attributes using the https://www.inetsoft.com/docs/stylebi/apidoc/index.html?inetsoft/report/lens/AttributeTableLens.html[TableLens API].
endif::ai[]
