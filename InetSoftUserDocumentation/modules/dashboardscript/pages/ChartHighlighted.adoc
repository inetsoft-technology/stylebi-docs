...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboard:ConditionalFormat.adoc[] in xref:dashboard:VisualizeYourData.adoc[] for basic information on highlights.
endif::ai[]

[WARNING,caption=See Also]
xref:dashboard:ConditionalFormat.adoc[] in xref:dashboard:VisualizeYourData.adoc[] for basic information on highlights.
