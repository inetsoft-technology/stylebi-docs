...
====
xref:dashboardscript:AccessComponentData.adoc#TableCrosstabComponents[Table/Crosstab Components]  in xref:AccessComponentData.adoc[] for information about working with table data.
====
