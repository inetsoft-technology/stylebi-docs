...
// metadata for AI
ifdef::ai[]
Summary: xref:PlotYFields.adoc[] to return the fields currently bound to Y-axis at runtime.
endif::ai[]
...
image::commonscript:bindingInfoXFields_1.png[alt="bar chart with Employee on X-axis and Total on Y-axis via yFields"]
