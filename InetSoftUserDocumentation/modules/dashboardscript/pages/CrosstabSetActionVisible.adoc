...
--
<1> The {buttonMore}.
<2> The {buttonExport}. Applies also when the Crosstab is used as a xref:dashboard:AddTipsToChart.adoc#DataTip[Data Tip].
<3> For xref:dashboard:AddFreehandTable.adoc[Freehand Table.]
