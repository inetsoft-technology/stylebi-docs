...
// metadata for AI
ifdef::ai[]
Summary: Sets the aggregation formula for one of the measures specified by xref:dashboardscript:CrosstabBindingInfoMeasureFields.adoc[]. This is equivalent to setting the ‘Aggregate’ method for a measure in the Crosstab Editor.
endif::ai[]


Sets the aggregation formula for one of the measures specified by xref:dashboardscript:CrosstabBindingInfoMeasureFields.adoc[]. This is equivalent to setting the ‘Aggregate’ method for a measure in the Crosstab Editor.

image::commonscript:bindingInfoSetFormula.png[alt="crosstab editor showing Aggregate method setting for a measure"]
