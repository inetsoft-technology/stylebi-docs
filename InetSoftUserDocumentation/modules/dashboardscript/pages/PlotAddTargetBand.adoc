...
// metadata for AI
ifdef::ai[]
Summary: Draws a set of horizontal or vertical target bands in the plot area using the specified colors and options. See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
endif::ai[]



Draws a set of horizontal or vertical target bands in the plot area using the specified colors and options.  See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
...
image::commonscript:PlotAddTargetBand1.png[alt="chart with target band spanning min to average range"]
...
image::commonscript:PlotAddTargetBand2.png[alt="chart with multiple target bands spanning min average and max ranges"]
