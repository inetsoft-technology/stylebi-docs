...
// metadata for AI
ifdef::ai[]
Summary: Script reference for the addImage(label, image) global function, which makes an image available in the Image Properties dialog Uploaded folder for use in Dashboard Image components.
endif::ai[]
:navtitle: addImage()
...
image::commonscript:addImage1.png[alt="Image Properties dialog box showing Uploaded folder with available images"]
