...
// metadata for AI
ifdef::ai[]
Summary: Replace the specified label on the axis with an alias.
endif::ai[]
...
image::commonscript:setLabelAlias.png[alt="chart axis labels with city names replaced by shorter aliases"]
