...
:page-aliases: viewsheetscript:ChartBindingInfoBreakdownFields.adoc
...
image:commonscript:bindingInfoBeakoutFields.png[alt="chart with Order Date as breakdown field grouping bar data"]
