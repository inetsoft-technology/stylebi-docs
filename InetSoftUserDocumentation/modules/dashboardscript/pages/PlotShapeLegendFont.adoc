...
// metadata for AI
ifdef::ai[]
Summary: Sets the font for labels within a shape-key legend.
endif::ai[]
...
image::commonscript:shapeLegendFont.png[alt="chart shape legend with custom font applied to legend text"]
