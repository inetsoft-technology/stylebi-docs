...
// metadata for AI
ifdef::ai[]
Summary: Draws a set of horizontal or vertical lines on the chart to mark the specified quantiles. See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
endif::ai[]



Draws a set of horizontal or vertical lines on the chart to mark the specified quantiles.  See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
...
image::commonscript:PlotAddTargetQuantile.png[alt="chart with four quantile target lines dividing chart into quartiles"]
