...
// metadata for AI
ifdef::ai[]
Summary: Sets the font for labels within a shape-key legend on Charts that have *multiple* shape legends.
endif::ai[]
...
image::commonscript:shapeLegendsFont.png[alt="chart shape legends with custom font applied to all legend text"]
