...
// metadata for AI
ifdef::ai[]
Summary: Sets the format for data values displayed within a color-key legend (on charts that have *multiple* color legends).
endif::ai[]
...
image::commonscript:colorLegendsFormat.png[alt="chart with all color legends having number format applied"]
