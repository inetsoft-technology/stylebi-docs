...
// metadata for AI
ifdef::ai[]
Summary: Draws a set of horizontal or vertical lines on the chart to mark the specified percentiles. See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
endif::ai[]



Draws a set of horizontal or vertical lines on the chart to mark the specified percentiles.  See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
...
image::commonscript:PlotAddTargetPercentile1.png[alt="chart with 95th percentile target line displayed in red"]
...
image::commonscript:PlotAddTargetPercentile2.png[alt="chart with multiple percentile target lines at 50 75 and 90"]
