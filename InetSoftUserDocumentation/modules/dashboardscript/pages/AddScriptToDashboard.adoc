...
// metadata for AI
ifdef::ai[]
Summary: If you need to modify a Dashboard at runtime, or implement more complex business logic, you can add script to your Dashboard. There are three levels at which you can attach script in a Dashboard:
endif::ai[]
