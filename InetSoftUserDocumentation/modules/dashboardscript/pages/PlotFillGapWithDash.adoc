...
// metadata for AI
ifdef::ai[]
Summary: When you designate a dimension as a “time series” (see xref:ChartBindingInfoSetTimeSeries.adoc[]) and set xref:PlotFillTimeGap.adoc[] to `true`, `fillGapWithDash` will linearly interpolate missing data using a *dashed line*.
endif::ai[]
