...
// metadata for AI
ifdef::ai[]
Summary: Specifies a hyperlink to a Dashboard or URL. The examples below illustrate how to use an array to pass parameters in the hyperlink.
endif::ai[]

[WARNING,caption=See Also]
====
[square]
* xref:dashboard:TextProperties.adoc[] for general information about Text components.
