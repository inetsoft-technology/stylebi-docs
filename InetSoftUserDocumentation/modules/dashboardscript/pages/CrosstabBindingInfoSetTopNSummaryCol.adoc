...
// metadata for AI
ifdef::ai[]
Summary: Sets the measure to use in ranking groups. This is equivalent to setting the ‘Of’ measure in the Crosstab Editor.
endif::ai[]


Sets the measure to use in ranking groups. This is equivalent to setting the ‘Of’ measure in the Crosstab Editor.

image::commonscript:bindingInfoSetTopNExp2.png[alt="crosstab editor showing Of measure field for ranking groups"]
...
image::commonscript:bindingInfoSetTopNExp1_1.png[alt="crosstab showing top 3 names ranked by Sum of Total measure"]
