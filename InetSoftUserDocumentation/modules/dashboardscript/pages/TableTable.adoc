...
====
xref:dashboardscript:AccessComponentData.adoc#TableCrosstabComponents[Table/Crosstab Components]  in xref:dashboardscript:AccessComponentData.adoc[]  for information about working with table data.
====
...
This property is read-only. To write data to an *Editable Table*, use  xref:dashboardscript:TableSetObject.adoc[] or xref:TableSetCellValue.adoc[].
