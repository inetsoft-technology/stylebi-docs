...
// metadata for AI
ifdef::ai[]
Summary: Specifies whether the subtotal for a given parent group should be displayed. When `true`, this is equivalent to selecting ‘Show’ in the ‘Summarize’ menu of the Crosstab Editor.
endif::ai[]
...
image::commonscript:bindingInfoSetGroupTotal.png[alt="crosstab editor showing Summarize Show option for group subtotals"]
...
image::commonscript:bindingInfoSetGroupTotalExp.png[alt="crosstab with Region row subtotals displayed for each region group"]
