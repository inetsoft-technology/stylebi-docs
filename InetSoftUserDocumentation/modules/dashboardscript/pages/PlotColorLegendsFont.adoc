...
// metadata for AI
ifdef::ai[]
Summary: Sets the font for labels within a color-key legend (on charts that have *multiple* color legends).
endif::ai[]
...
image::commonscript:colorLegendsFont.png[alt="chart with all color legends having font changed"]
