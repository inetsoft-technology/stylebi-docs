...
// metadata for AI
ifdef::ai[]
Summary: Draws a set of horizontal or vertical lines on the chart to mark the specified percentage figures. See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
endif::ai[]



Draws a set of horizontal or vertical lines on the chart to mark the specified percentage figures.  See xref:dashboard:AddTargetLineTrendLine.adoc[] for more information about target lines.
...
image::commonscript:PlotAddTargetPercentage1.png[alt="chart with single percentage target line at 125 percent of average"]
...
image::commonscript:PlotAddTargetPercentage2.png[alt="chart with multiple percentage target lines at 30 60 and 90 percent"]
