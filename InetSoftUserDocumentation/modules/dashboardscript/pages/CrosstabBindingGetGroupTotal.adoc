...
// metadata for AI
ifdef::ai[]
Summary: Returns `true` if the subtotal for the specified group is being displayed, `false` otherwise. This property can be set by xref:CrosstabBindingInfoSetGroupTotal.adoc[] or by the '`Summarize`' property in the Crosstab Editor.
endif::ai[]
...
image::commonscript:bindingInfoSetGroupTotal_1.png[alt="crosstab editor showing Summarize subtotal option for a grouped field"]
