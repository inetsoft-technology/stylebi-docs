...
====
* xref:dashboardscript:TableTable.adoc[] for more information about the `table` array.
* xref:dashboard:TableProperties.adoc[] for general information about the Table component.
====
...
See xref:dashboard:DynamicallySetProperties.adoc#ControlPropertieswithExpression[Control Properties with Expression] for information about how to use expressions to set properties.
