...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboard:DrillDownIntoData.adoc[] for more information about flyover views.
endif::ai[]

include::partial$readOnly.adoc[]

[WARNING,  caption=See Also]
xref:dashboard:DrillDownIntoData.adoc[] for more information about flyover views.
...
image::dataConditions2.png[alt="dashboard with chart using flyover view to filter a table component"]
...
image::dataConditions.png[alt="table with title bar showing current flyover filter from chart selection"]
