...
// metadata for AI
ifdef::ai[]
Summary: Sets the number of row or column groups to preserve in the ranking. This is equivalent to setting the number '`N`' of ranking groups for the '`Rank`' property of the Crosstab Editor.
endif::ai[]
...
image::commonscript:bindingInfoSetTopN.png[alt="crosstab editor showing Rank N option for filtering top groups"]
...
image::commonscript:bindingInfoSetTopNExp1.png[alt="crosstab showing top 3 names by Sum of Total with column totals"]
