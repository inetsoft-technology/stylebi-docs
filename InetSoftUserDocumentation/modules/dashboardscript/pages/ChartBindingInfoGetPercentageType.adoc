...
// metadata for AI
ifdef::ai[]
Summary: xref:dashboardscript:ChartBindingInfoSetPercentageType.adoc[] to set the binding information.
endif::ai[]


[WARNING,caption=See Also]
xref:dashboardscript:ChartBindingInfoSetPercentageType.adoc[]  to set the binding information.
