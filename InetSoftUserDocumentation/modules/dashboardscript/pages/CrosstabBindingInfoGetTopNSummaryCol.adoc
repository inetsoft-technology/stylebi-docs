...
// metadata for AI
ifdef::ai[]
Summary: Returns the measure set for ranking by xref:CrosstabBindingInfoSetTopNSummaryCol.adoc[] or by the '`Of`' property in the Crosstab Editor.
endif::ai[]
...
image::commonscript:bindingInfoSetTopNExp2_1.png[alt="crosstab editor with Of measure property set for top-N ranking"]
