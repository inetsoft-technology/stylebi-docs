...
* xref:CommonSelectLabel.adoc[] to access the label corresponding to the value.
* xref:CommonSelectObjects.adoc[] to access the currently selected values  in multi-valued components.
