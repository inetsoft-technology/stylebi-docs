...
// metadata for AI
ifdef::ai[]
Summary: Sets the contents of an *Editable Table* cell to the specified value. See xref:viewsheet:TableProperties.adoc[] for information on how to make a Table editable.
endif::ai[]
