...
// metadata for AI
ifdef::ai[]
Summary: xref:viewsheetscript:GaugeQuery.adoc[] to specify the data block from which to draw the fields.
endif::ai[]
...
image::viewsheetscript:GaugeFields.png[alt="gauge component Data tab showing Columns field binding selection"]
