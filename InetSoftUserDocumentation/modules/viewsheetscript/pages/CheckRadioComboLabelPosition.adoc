...
// metadata for AI
ifdef::ai[]
Summary: Specifies the position of the label relative to the component (Combo Box component *only*). See xref:viewsheet:RadioCheckBoxComboProperties.adoc[] for information on the '`Label Position`' option.
endif::ai[]
