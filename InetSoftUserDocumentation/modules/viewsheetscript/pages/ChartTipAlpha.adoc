...
// metadata for AI
ifdef::ai[]
Summary: Sets the transparency (alpha) of the data tip for the Chart. A *data tip* is a graphical form of tooltip that displays a specified Dashboard component when the user hovers the mouse over a group on the Chart. See xref:viewsheet:AddTipsToChart.adoc[] for more details.
endif::ai[]
