...
// metadata for AI
ifdef::ai[]
Summary: Populate empty cells of the Freehand Table with zeros. (Empty data cells occur when no results exist corresponding to the row and column headings.)
endif::ai[]
