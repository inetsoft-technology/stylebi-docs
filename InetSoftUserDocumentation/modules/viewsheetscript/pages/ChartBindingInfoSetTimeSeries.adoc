...
// metadata for AI
ifdef::ai[]
Summary: xref:ChartBindingInfoIsTimeSeries.adoc[] to obtain the time-series status.
endif::ai[]
...
image::commonscript:setTimeSeries_1.png[alt="chart with date gaps preserved as empty intervals in time series"]
