...
// metadata for AI
ifdef::ai[]
Summary: Specifies whether a trailing column containing totals should be displayed. This is equivalent to setting ‘Column Total’ in the Crosstab Editor.
endif::ai[]
...
image::commonscript:bindingInfoshowColumnTotal.png[alt="crosstab editor with Column Total option enabled"]
...
image::commonscript:bindingInfoshowColumnTotal2.png[alt="crosstab with trailing column displaying grand totals for all measures"]
