...
// metadata for AI
ifdef::ai[]
Summary: Specifies the data blocks to be merged in the Range Slider component. (The available data blocks appear at the top of the *Toolbox* panel in Visual Composer.) See xref:viewsheet:AddFilterComponents.adoc[] for more information about merging compatible data blocks.
endif::ai[]
