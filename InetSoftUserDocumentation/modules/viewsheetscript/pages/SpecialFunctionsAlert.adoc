...
// metadata for AI
ifdef::ai[]
Summary: xref:SpecialFunctionsConfirm.adoc[] to prompt the user with a choice dialog box.
endif::ai[]
...
image::administration:alertFunction_1.png[alt="dashboard showing dark-color toast notification with alert message displayed"]
