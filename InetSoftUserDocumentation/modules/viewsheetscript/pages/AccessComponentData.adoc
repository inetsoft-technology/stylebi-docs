...
image::viewsheet:ComponentSelectedObject.png[alt="script editor component tree showing selectedObject node"]
...
+
image::viewsheet:Object Access RadioButton.png[alt="radio button with two label and value entries added"]
...
+
image::viewsheet:Object Access Viewsheet.png[alt="dashboard with radio button selection list and range slider"]
...
+
image::viewsheet:Selection List Properties Expression.png[alt="selection list properties with enabled set to expression"]
...
image::viewsheet:RelativeReferenceEditor.png[alt="script editor component tree showing table data and field nodes"]
...
+
image::viewsheet:ProductInfoDataBlock.png[alt="ProductInfo data block table added to the dashboard"]

. Click to select any data cell in the ‘Price’ column. Then select the *Format* tab at the bottom of the left panel.
+
image::viewsheet:Capture_009.png[alt="Price column cell selected with Format tab visible"]
...
+
image::viewsheet:Capture_011.png[alt="table with Price column cells colored red for values over 1000"]
...
. Press btn:[OK] to exit the Formula Editor.
+
image::viewsheetscript:Set Property Using Field.png[alt="Name column highlighted based on corresponding Price column values"]
...
image::viewsheet:Expression Access Relative Cell.png[alt="table with cells highlighted yellow where price is less than row above"]
...
. Press btn:[OK] to exit the Formula Editor.
+
image::viewsheet:Expression Access Absolute Cell.png[alt="Price column header cell shown red because a price exceeds 2000"]
...
+
image::viewsheet:Expression Drag Price Slider.png[alt="Range Slider bound to Price field added to the dashboard"]
