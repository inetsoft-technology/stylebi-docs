...
// metadata for AI
ifdef::ai[]
Summary: Specifies that users can edit the values in existing rows of an *Editable Table*. See xref:viewsheet:WriteBackToStorage.adoc#AccessUserModifiedData[Access User-Modified Data] for more details. (Use xref:TableForm.adoc[] to make a Table editable.)
endif::ai[]
