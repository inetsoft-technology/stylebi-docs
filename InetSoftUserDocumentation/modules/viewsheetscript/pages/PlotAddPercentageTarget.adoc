...
// metadata for AI
ifdef::ai[]
Summary: Draws a set of horizontal or vertical lines on the chart to mark the specified percentage figures. See xref:viewsheet:AddTargetLineTrendLine.adoc[] for more information about target lines.
endif::ai[]
