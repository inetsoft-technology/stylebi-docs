...
image::viewsheet:Expression Select Popup.png[alt="property field showing the value type button with Expression option"]
...
+
image::viewsheet:Right Click Properties.png[alt="right-click context menu showing Properties option for a component"]
...
+
image::viewsheet:Expression Option.png[alt="Visible property with Expression selected from value type menu"]

. Press the {buttonEditFormula} to open the Formula Editor.
+
image::viewsheet:Edit Expression Button.png[alt="edit formula button enabled next to Expression property field"]
...
+
image::viewsheet:Formula Editor Function.png[alt="formula editor with Functions list and Components panel visible"]
+
...
+
image::viewsheet:ScriptEditorText.png[alt="script editor Script tab with Script and onClick buttons at bottom"]
+
...
image::viewsheet:scriptComponentSymbol.png[alt="component with JS symbol in top-left corner indicating attached script"]
...
+
image::viewsheet:ViewsheetOptionsDialog.png[alt="Dashboard Options dialog box with Script tab showing script editor"]
