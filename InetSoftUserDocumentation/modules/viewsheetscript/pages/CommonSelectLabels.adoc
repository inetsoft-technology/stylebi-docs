...
* xref:CommonSelectObjects.adoc[] to access the value corresponding to the labels.
* xref:CommonSelectLabel.adoc[] to access the currently selected label in single-valued components.
