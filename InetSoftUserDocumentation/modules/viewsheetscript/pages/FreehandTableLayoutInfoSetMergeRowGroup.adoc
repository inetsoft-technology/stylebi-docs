...
// metadata for AI
ifdef::ai[]
Summary: Sets the row group for the specified merged cells in a Freehand Table. See xref:viewsheet:AddFreehandTable.adoc[] for more information about ‘Row Group’ for merged cells.
endif::ai[]
