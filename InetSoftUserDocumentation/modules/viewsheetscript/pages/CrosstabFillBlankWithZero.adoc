...
// metadata for AI
ifdef::ai[]
Summary: Populate empty cells of the crosstab table with zeros. (Empty data cells occur when no results exist corresponding to the row and column headings.)
endif::ai[]
