...
// metadata for AI
ifdef::ai[]
Summary: Draws a set of horizontal or vertical confidence intervals on the chart. See xref:viewsheet:AddTargetLineTrendLine.adoc[] for more information about target lines.
endif::ai[]
