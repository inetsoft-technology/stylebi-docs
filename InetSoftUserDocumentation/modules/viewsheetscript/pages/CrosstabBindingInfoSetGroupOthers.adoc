...
// metadata for AI
ifdef::ai[]
Summary: Specifies whether groups excluded from the ranking should be grouped as ‘Others’. When `true`, this is equivalent to checking ‘Group all others together’ in the Crosstab Editor.
endif::ai[]
...
image::commonscript:bindingInfoSetGroupOthers.png[alt="crosstab editor showing Group all others together checkbox option"]
...
image::commonscript:bindingInfoSetGroupOthers2.png[alt="crosstab showing bottom 3 names with remaining groups combined as Others"]
