...
// metadata for AI
ifdef::ai[]
Summary: Returns the percent setting set by xref:CrosstabBindingInfoSetPercentageType.adoc[] for one of the measures specified by xref:CrosstabBindingInfoMeasureFields.adoc[], or set as the percent representation for a measure in '`Trend and Comparison`' property of the Crosstab Editor.
endif::ai[]
...
image::commonscript:bindingInfoSetFormula_2.png[alt="crosstab editor Trend and Comparison with percentage type option set"]
