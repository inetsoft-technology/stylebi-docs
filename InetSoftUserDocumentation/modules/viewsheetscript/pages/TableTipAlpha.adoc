...
// metadata for AI
ifdef::ai[]
Summary: Sets the transparency (alpha) of the data tip for the Table or Crosstab. A *data tip* is a graphical form of tooltip that displays a specified Dashboard component when the user hovers the mouse over cells in the Table. See xref:viewsheet:AddTipsToChart.adoc[] for more details about data tips.
endif::ai[]
