...
// metadata for AI
ifdef::ai[]
Summary: The functions in this section are commonly used to populate cells in a Freehand Table.
endif::ai[]
...
+
image::viewsheet:freehandExp22.png[alt="Dashboard Options Script tab with Sales Explore runQuery entered in onInit"]
+
...
+
image::viewsheet:freehandExp34.png[alt="freehand table editor with Formula selected for rowList expression cell"]
...
+
image::viewsheet:freehandExp31.png[alt="freehand table with Expand Cell Vertical set for rowList date column"]
...
+
image::viewsheet:freehandExp32.png[alt="freehand table editor with field category formula for second column"]

. {finishEditing} The resulting table displays the date for all orders greater than $10,000, and the corresponding category.
+
image::viewsheet:freehandExp33.png[alt="freehand table showing dates and categories for orders greater than ten thousand"]
====
