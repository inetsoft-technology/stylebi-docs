...
// metadata for AI
ifdef::ai[]
Summary: Specifies the direction (row or column) for percentage computation. This is equivalent to selecting the ‘By’ option of the ‘Calculation’ dialog box in the Crosstab Editor (accessible from btn:[Edit] button under the {buttonEditMeasure}).
endif::ai[]
...
image::commonscript:bindingInfoPercentMode.png[alt="crosstab editor Calculation dialog showing By row or column direction option"]
