...
// metadata for AI
ifdef::ai[]
Summary: Sets the font of the dimension or measure axis labels.
endif::ai[]
...
image::commonscript:dimensionFont.png[alt="chart with axis labels displayed in bold serif font"]
