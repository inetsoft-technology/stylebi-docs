...
// metadata for AI
ifdef::ai[]
Summary: Specifies the initial upper end (right side) of the selected range. This property should be set in the *onInit* handler (See xref:viewsheetscript:AddScriptToDashboard.adoc#AddDashboardScript[Add Dashboard Script] for more information about handlers.)
endif::ai[]
