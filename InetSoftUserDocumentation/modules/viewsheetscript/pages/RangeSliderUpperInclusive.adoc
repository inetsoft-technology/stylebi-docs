...
image::viewsheet:Range Slider Inclusive.png[alt="range slider showing upper limit value 15 included in selection range"]


A setting of `upperInclusive=false` in this case excludes the value 15 from the result set.

image::viewsheet:Range Slider Exclusive.png[alt="range slider showing upper limit value 15 excluded from selection range"]
