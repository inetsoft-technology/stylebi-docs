...
Typically, when you access query data using the methods described below, you will display this data within the cells of a Freehand Table.  The following sections provide several examples of how to do this.
