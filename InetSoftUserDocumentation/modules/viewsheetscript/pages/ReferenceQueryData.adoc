...
image::viewsheet:Freehand Table Cell Reference_1.png[alt="freehand table cell with name assigned in Cell Name field"]

You can insert this reference easily by selecting the field name from the ‘Cell’ folder in the editor.

image::viewsheet:Freehand Table Cell Reference2_1.png[alt="formula editor showing cell reference inserted from Cell folder"]
...
+
image::viewsheet:freehandExp1.png[alt="Dashboard Options Script tab with runQuery entered in onInit script"]
+
...
+
image::viewsheet:freehandExp2.png[alt="freehand table editor with Formula option selected for cell"]
...
+
image::viewsheet:freehandExp3.png[alt="freehand table with Expand Cell set to Vertical and state column data populated"]
+
Observe that the table is populated with all the records from the ‘state’ column of the ‘customers’ query.
+
image::viewsheet:freehandExp4.png[alt="freehand table populated with all state values from customers query"]
+
To return just the unique values in the ‘state’ column, change the script from `q['state']` to `toList(q['state'])`.
+
image::viewsheet:freehandExp5.png[alt="freehand table showing unique state values using toList function"]
====
...
. Select the ‘Formula’ option and press the btn:[Edit] button.
+
image::viewsheet:freehandExp2_1.png[alt="freehand table editor with Formula selected for derived column expression"]
...
. Select ‘Expand Cell’ and choose ‘Vertical’. (This causes the extracted data to fill down vertically.)
+
image::viewsheet:freehandExp6.png[alt="freehand table editor showing concatenation formula for state and zip fields"]
+
Observe that the table is populated with the concatenated values of ‘state’ and ‘zip’.
+
image::viewsheet:freehandExp7.png[alt="freehand table populated with concatenated state and zip values"]
====
...
+
image::viewsheet:freehandExp8.png[alt="freehand table structure with four rows and three columns inserted"]
+
...
. Select the ‘Formula’ option and press the btn:[Edit] button.
+
image::viewsheet:freehandExp2_2.png[alt="freehand table editor with Formula selected for second example cell"]
...
. Select ‘Expand Cell’ and choose ‘Vertical’. (This causes the extracted data to fill down vertically.)
+
image::viewsheet:freehandExp3_1.png[alt="freehand table with Expand Cell Vertical set for state column"]

. In the ‘Cell Name’ field, enter ‘`st`’ as the cell name.
+
image::viewsheet:freehandExp9.png[alt="freehand table cell name field showing st entered as cell name"]
...
+
image::viewsheet:freehandExp10.png[alt="freehand table formula editor showing city column extraction formula"]

. Select ‘Expand Cell’ and choose ‘Vertical’.

. In the ‘Cell name’ field, enter ‘`ct`’ as the cell name.
+
image::viewsheet:freehandExp11.png[alt="freehand table cell name field showing ct entered as cell name"]

. {finishEditing} Observe that the table is now populated with states and cities.
+
image::viewsheet:freehandExp12.png[alt="freehand table showing all states with all cities in adjacent column"]
+
...
+
image::viewsheet:freehandExp13.png[alt="freehand table formula with field filtering to show cities matching current state"]
+
...
+
image::viewsheet:freehandExp14.png[alt="freehand table showing only cities that correspond to each state row"]
+
...
+
image::viewsheet:freehandExp15.png[alt="freehand table editor with customer count formula and Expand Cell Vertical set"]

. {finishEditing} The Table now displays a count of customer IDs within each city and state.
+
image::viewsheet:freehandExp16.png[alt="freehand table showing customer count per city within each state"]
====
...
+
image::viewsheet:freehandExp17.png[alt="freehand table with state group numbers displayed in first column"]
+
...
+
image::viewsheet:freehandExp18.png[alt="freehand table Option tab with Merge expanded cells enabled and st row group selected"]
...
+
image::viewsheet:freehandExp19.png[alt="freehand table Option tab with Merge expanded cells enabled for city column"]

. {finishEditing} Note how repeated states and group numbers have been merged together.
+
image::viewsheet:freehandExp20.png[alt="freehand table with repeated state names and group numbers merged into single cells"]
...
+
image::viewsheet:freehandExp21.png[alt="Visual Composer Format tab showing Middle vertical alignment applied to cells"]
====
...
+
image::viewsheet:freehandExp22.png[alt="Dashboard Options Script tab with Sales Explore runQuery in onInit"]
+
...
. Select the ‘Formula’ option and press the btn:[Edit] button.
+
image::viewsheet:freehandExp23.png[alt="freehand table editor with Formula selected for year group header cell"]
...
. Select ‘Expand Cell’ and choose ‘Vertical’. (This causes the extracted data to fill down vertically.)
+
image::viewsheet:freehandExp24.png[alt="freehand table with year column set to Expand Cell Vertical"]

. In the ‘Cell Name’ field, enter ‘`yr`’ as the cell name.
+
image::viewsheet:freehandExp25.png[alt="freehand table cell name field showing yr entered as cell name"]
...
+
image::viewsheet:freehandExp26.png[alt="freehand table cell name field showing tot entered for annual totals cell"]
...
+
image::viewsheet:freehandExp27.png[alt="freehand table editor showing relative cell reference formula for year-over-year difference"]

. {finishEditing} The resulting table displays totals by year, as well as the difference between successive years’ totals.
+
image::viewsheet:freehandExp28.png[alt="freehand table displaying annual totals and year-over-year differences"]
====
...
+
image::viewsheet:freehandExp22_1.png[alt="Dashboard Options Script tab with Sales Explore runQuery entered for absolute reference example"]
+
...
. Select the ‘Formula’ option and press the btn:[Edit] button.
+
image::viewsheet:freehandExp23_1.png[alt="freehand table editor with Formula selected for second absolute reference walkthrough"]
...
. Select ‘Expand Cell’ and choose ‘Vertical’. (This causes the extracted data to fill down vertically.)
+
image::viewsheet:freehandExp24_1.png[alt="freehand table with year column Expand Cell Vertical set for second walkthrough"]

. In the ‘Cell Name’ field, enter ‘`yr`’ as the cell name.
+
image::viewsheet:freehandExp25_1.png[alt="freehand table cell name field showing yr for second absolute reference walkthrough"]
...
. In the ‘Cell Name’ field, enter ‘`tot`’ as the cell name.
+
image::viewsheet:freehandExp26_1.png[alt="freehand table cell name field showing tot for second absolute reference walkthrough"]
...
This formula uses absolute cell referencing to calculate the difference between the total revenue (computed in the column named ‘tot’) of the current year and the year 2017. The table should appear as shown below:
+
image::viewsheet:freehandExp30.png[alt="freehand table editor showing absolute year reference formula for 2017 comparison"]

. {finishEditing} The resulting table displays totals by year, as well as the difference between each year’s total and the total for 2017.
+
image::viewsheet:freehandExp29.png[alt="freehand table showing annual totals and difference from 2017 baseline"]
====
