...
// metadata for AI
ifdef::ai[]
Summary: xref:viewsheetscript:CalendarQuery.adoc[] to specify the data block from which to draw the fields.
endif::ai[]
...
image::viewsheet:calendarFields.png[alt="calendar component Data tab showing fields property binding"]
