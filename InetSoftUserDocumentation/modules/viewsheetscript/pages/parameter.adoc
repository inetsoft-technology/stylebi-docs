...
Returns the hostname of the  server hosting the dashboard.
...
Returns the URI at which the current dashboard is being accessed.
...
=== Example
[source,javascript]
alert('This dashboard URI is ' + parameter.__LINK_URI__)
