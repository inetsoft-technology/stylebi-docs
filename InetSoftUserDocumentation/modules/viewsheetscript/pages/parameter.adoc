...
image::viewsheetscript:parameterLINKHOST.png[alt="alert dialog displaying server hostname from LINK_HOST parameter"]
...
image::viewsheetscript:parameterLINKURI.png[alt="alert dialog displaying dashboard root URL from LINK_URI parameter"]
