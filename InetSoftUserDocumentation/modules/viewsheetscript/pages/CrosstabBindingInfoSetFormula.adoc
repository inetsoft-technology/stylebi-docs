...
// metadata for AI
ifdef::ai[]
Summary: Sets the aggregation formula for one of the measures specified by xref:viewsheetscript:CrosstabBindingInfoMeasureFields.adoc[]. This is equivalent to setting the ‘Aggregate’ method for a measure in the Crosstab Editor.
endif::ai[]
