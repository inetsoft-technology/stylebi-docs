...
* xref:CommonSelectObject.adoc[] to access the value corresponding to the label.
* xref:CommonSelectLabels.adoc[] to access the currently selected labels in multi-valued components.
