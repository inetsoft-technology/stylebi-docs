...
// metadata for AI
ifdef::ai[]
Summary: xref:chartAPI:FacetCoord.adoc[] for an example of creating a facet chart.
endif::ai[]
...
image::commonscript:measureSharedRange.png[alt="facet chart with independent Y-axis scales per sub-graph"]
